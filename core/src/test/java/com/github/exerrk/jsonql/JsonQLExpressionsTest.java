 ...
 */
package com.github.exerrk.jsonql;
...
import com.github.exerrk.engine.util.json.DefaultJsonQLExecuter;
...
public class JsonQLExpressionsTest {
    ...
    public void readJson() throws JRException {
        JsonNode tree = JsonUtil.parseJson(DefaultJasperReportsContext.getInstance(), "com/github/exerrk/jsonql/orders.json");
    ...
    public void expectedResult(Method method) throws JRException {
        expectedResult = JsonUtil.parseJson(DefaultJasperReportsContext.getInstance(),
                "com/github/exerrk/jsonql/" + method.getName() + "_result.json");
    }
