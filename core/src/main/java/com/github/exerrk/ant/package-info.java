...
* definitions, based on the {@link com.github.exerrk.ant.JRBaseAntTask JRBaseAntTask} class.
* <br/>
...
* <br/>
* This Ant task is implemented by the {@link com.github.exerrk.ant.JRAntCompileTask JRAntCompileTask} class. Its syntax and behavior are
...
* <pre>
* &lt;taskdef name="jrc" 
* classname="com.github.exerrk.ant.JRAntCompileTask"&gt;
*   &lt;classpath&gt; 
*     &lt;fileset dir="./lib"&gt; 
*       &lt;include name="** /*.jar"/&gt; 
*     &lt;/fileset&gt; 
...
* <li><code>compiler</code>: Name of the class that implements the {@link com.github.exerrk.engine.design.JRCompiler JRCompiler} interface to be used for compiling the reports (optional).</li>
...
* provides becomes very handy. It is implemented by the {@link com.github.exerrk.ant.JRAntDecompileTask JRAntDecompileTask} class and its declaration inside a
* <code>build.xml</code> file should be as follows:
* <pre> 
* &lt;taskdef name="jrdc" 
* classname="com.github.exerrk.ant.JRAntDecompileTask"&gt;
...
* the {@link com.github.exerrk.engine.xml.JRXmlLoader JRXmlLoader} or {@link com.github.exerrk.engine.util.JRLoader JRLoader}
* and the {@link com.github.exerrk.engine.xml.JRXmlWriter JRXmlWriter}.
* <br/>
...
* {@link com.github.exerrk.ant.JRAntUpdateTask JRAntUpdateTask} class, which should have the
* following definition in a <code>build.xml</code> file: 
* <pre>
* &lt;taskdef name="jru" 
* classname="com.github.exerrk.ant.JRAntUpdateTask"&gt;
*   &lt;classpath refid="classpath"/&gt; 
* &lt;/taskdef&gt;
* </pre> 
