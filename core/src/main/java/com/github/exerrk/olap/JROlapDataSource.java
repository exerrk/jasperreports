...
import com.github.exerrk.olap.mapping.AxisPosition;
import com.github.exerrk.olap.mapping.DataMapping;
import com.github.exerrk.olap.mapping.Mapping;
import com.github.exerrk.olap.mapping.MappingLexer;
import com.github.exerrk.olap.mapping.MappingMetadata;
import com.github.exerrk.olap.mapping.MappingParser;
import com.github.exerrk.olap.mapping.Member;
import com.github.exerrk.olap.mapping.MemberDepth;
import com.github.exerrk.olap.mapping.MemberMapping;
import com.github.exerrk.olap.mapping.MemberProperty;
import com.github.exerrk.olap.mapping.Tuple;
import com.github.exerrk.olap.mapping.TuplePosition;
import com.github.exerrk.olap.result.JROlapCell;
import com.github.exerrk.olap.result.JROlapHierarchy;
import com.github.exerrk.olap.result.JROlapHierarchyLevel;
import com.github.exerrk.olap.result.JROlapMember;
import com.github.exerrk.olap.result.JROlapMemberTuple;
import com.github.exerrk.olap.result.JROlapResult;
import com.github.exerrk.olap.result.JROlapResultAxis;
...
public class JROlapDataSource implements JRDataSource, MappingMetadata
{
	...
	protected void processMemberInfo(com.github.exerrk.olap.mapping.Member member)
	{
	...
	@Override
	public int getDimensionIndex(com.github.exerrk.olap.mapping.Axis axis, String dimension)
	{
	...
	protected void setMatchMemberDepth(com.github.exerrk.olap.mapping.Member memberInfo, JROlapMember member)
	{
	...
	protected abstract class FieldMatcher
	{
		...
		public final JROlapMember member(com.github.exerrk.olap.mapping.Member memberInfo, int[] positions)
		{
	...
	{
		final com.github.exerrk.olap.mapping.Member memberInfo;
	...
	protected class DataFieldMatcher extends FieldMatcher
	{
		...
		private final com.github.exerrk.olap.mapping.Member[] members;
