 ...
 */
package com.github.exerrk.renderers.util;
...
public class RendererUtil
{
	...
	public static boolean isLazy(Renderable renderer)
	{
		...
		else if (renderer != null)
		{
			...
			Class<?> depClass = com.github.exerrk.engine.JRImageRenderer.class;
			if (depClass.equals(renderer.getClass()))
			{
				@SuppressWarnings("deprecation")
				com.github.exerrk.engine.JRImageRenderer depRenderer = (com.github.exerrk.engine.JRImageRenderer)renderer;
				@SuppressWarnings("deprecation")
