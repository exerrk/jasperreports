...
import com.github.exerrk.search.LuceneUtil;
import com.github.exerrk.search.SpansInfo;
import com.github.exerrk.web.WebReportContext;
import com.github.exerrk.web.servlets.JasperPrintAccessor;
	...
	public void performAction() throws ActionException {
		if (searchData != null && searchData.getSearchString() != null && searchData.getSearchString().length() > 0) {
			...
			try {
				...
				reportContext.setParameterValue("com.github.exerrk.search.term.highlighter", spansInfo);
				...
				reportContext.setParameterValue("com.github.exerrk.web.actions.result.json", result);
