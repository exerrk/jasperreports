...
public class ViewerServlet extends AbstractServlet
{
	...
	public static final String PROPERTY_TEMPLATE_HEADER = "com.github.exerrk.web.servlets.viewer.header.template";
	public static final String PROPERTY_TEMPLATE_BODY = "com.github.exerrk.web.servlets.viewer.body.template";
	public static final String PROPERTY_TEMPLATE_FOOTER = "com.github.exerrk.web.servlets.viewer.footer.template";
