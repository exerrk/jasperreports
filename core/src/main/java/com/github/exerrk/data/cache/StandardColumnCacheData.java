...
public class StandardColumnCacheData implements Serializable, ColumnCacheData
{
	...
	/* (non-Javadoc)
	 * @see com.github.exerrk.data.cache.ColumnCacheData#isSerializable()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.github.exerrk.data.cache.ColumnCacheData#createDataSource()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.github.exerrk.data.cache.ColumnCacheData#size()
	 */
	@Override
	public int size()
	{
	...
	/* (non-Javadoc)
	 * @see com.github.exerrk.data.cache.ColumnCacheData#getParameters()
	 */
	@Override
