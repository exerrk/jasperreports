...
import com.github.exerrk.data.RepositoryDataLocation;
import com.github.exerrk.data.StandardRepositoryDataLocation;
...
public class CsvDataAdapterImpl extends AbstractDataAdapter implements CsvDataAdapter
{
	...
	/**
	 * @deprecated replaced by {@link #setDataFile(com.github.exerrk.data.DataFile)} and {@link StandardRepositoryDataLocation}
	 */
	@Override
	@Deprecated
