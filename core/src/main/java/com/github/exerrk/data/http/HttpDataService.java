...
import com.github.exerrk.data.DataFileConnection;
import com.github.exerrk.data.DataFileService;
...
import com.github.exerrk.util.SecretsUtil;
...
public class HttpDataService implements DataFileService
{
	...
	public static final String HTTP_DATA_SERVICE_NAME = "com.github.exerrk.data.file.service:HTTP";
