...
public class ParametersExporterInput extends SimpleExporterInput
{
	 ...
	 * 
	 */
	public ParametersExporterInput(Map<com.github.exerrk.engine.JRExporterParameter, Object> parameters)
	{
	...
	private static List<JasperPrint> getJasperPrintList(Map<com.github.exerrk.engine.JRExporterParameter, Object> parameters)
	{
		List<JasperPrint> jasperPrintList = 
			(List<JasperPrint>)parameters.get(com.github.exerrk.engine.JRExporterParameter.JASPER_PRINT_LIST);
		if (jasperPrintList == null)
		{
			JasperPrint jasperPrint = (JasperPrint)parameters.get(com.github.exerrk.engine.JRExporterParameter.JASPER_PRINT);
			if (jasperPrint == null)
			{
				try
				{
					InputStream is = (InputStream)parameters.get(com.github.exerrk.engine.JRExporterParameter.INPUT_STREAM);
					if (is != null)
					{
					...
					{
						URL url = (URL)parameters.get(com.github.exerrk.engine.JRExporterParameter.INPUT_URL);
						if (url != null)
						{
						...
						{
							File file = (File)parameters.get(com.github.exerrk.engine.JRExporterParameter.INPUT_FILE);
							if (file != null)
							{
							...
							{
								String fileName = (String)parameters.get(com.github.exerrk.engine.JRExporterParameter.INPUT_FILE_NAME);
								if (fileName != null)
								{
