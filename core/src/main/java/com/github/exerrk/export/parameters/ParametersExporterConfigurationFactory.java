...
import com.github.exerrk.export.PropertiesExporterConfigurationFactory;
...
//				(Class<?>[]) allInterfaces.toArray(new Class<?>[allInterfaces.size()]),
	...
	protected Object getPropertyValue(Method method)
	{
		...
		com.github.exerrk.engine.JRExporterParameter parameter = null;
		...
		if (exporterParameter != null)
		{
			...
			{
				parameter = 
					(com.github.exerrk.engine.JRExporterParameter)exporterParameter.type().getField(
