...
import com.github.exerrk.engine.export.FileXmlResourceHandler;
import com.github.exerrk.engine.export.XmlResourceHandler;
...
public class ParametersXmlExporterOutput extends ParametersWriterExporterOutput implements XmlExporterOutput
{
		...
		if (sb == null)
		{
			...
			if (writer == null)
			{
				...
				if (os == null)
				{
					...
					Boolean isEmbeddingImagesParameter = (Boolean)parameters.get(com.github.exerrk.engine.export.JRXmlExporterParameter.IS_EMBEDDING_IMAGES);
	...
	{
		encoding = (String)parameters.get(com.github.exerrk.engine.JRExporterParameter.CHARACTER_ENCODING);
		if (encoding == null)
		{
