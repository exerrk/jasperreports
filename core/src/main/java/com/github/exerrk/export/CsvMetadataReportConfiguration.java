...
import com.github.exerrk.engine.export.JRCsvMetadataExporter;
...
public interface CsvMetadataReportConfiguration extends CsvReportConfiguration
{
	 ...
	 */
	@Property(
			name = "com.github.exerrk.export.csv.column.names.{arbitrary_name}",
			category = PropertyConstants.CATEGORY_EXPORT,
	...
	@ExporterParameter(
		type=com.github.exerrk.engine.export.JRCsvMetadataExporterParameter.class,
		name="WRITE_HEADER"
		) 
	@ExporterProperty(
