...
public interface ReportExportConfiguration extends CommonExportConfiguration
{
	...
	/**
	 * Return a {@link com.github.exerrk.engine.export.JRExportProgressMonitor JRExportProgressMonitor} instance for monitoring export status.
	...
	/**
	 * Returns an instance of the {@link com.github.exerrk.engine.export.ExporterFilter ExporterFilter} interface to be used by the exporter
	...
	/**
	 * Returns a {@link com.github.exerrk.engine.export.JRHyperlinkProducerFactory JRHyperlinkProducerFactory} which should be used for custom
