...
public class ParametersGraphics2DExporterOutput implements Graphics2DExporterOutput
{
	 ...
	 * 
	 */
	public ParametersGraphics2DExporterOutput(Map<com.github.exerrk.engine.JRExporterParameter, Object> parameters)
	{
		grx = (Graphics2D)parameters.get(com.github.exerrk.engine.export.JRGraphics2DExporterParameter.GRAPHICS_2D);
		if (grx == null)
		{
			throw 
