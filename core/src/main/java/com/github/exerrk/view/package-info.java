 ...
 * be viewed or printed. The {@link com.github.exerrk.swing.JRViewer} class represents
 ...
 * {@link com.github.exerrk.view.JasperViewer} class and is used in almost all the
 ...
 * <ul>
 * <li>{@link com.github.exerrk.view.JasperViewer} - use this class to view generated reports,
 * either as in-memory objects or serialized objects on disk or even stored in XML format.</li>
 * <li>{@link com.github.exerrk.view.JasperDesignViewer} - use this class to preview report templates,
 ...
 * {@link com.github.exerrk.swing.JRViewer} class and its companions. It is in fact a
 ...
 * {@link com.github.exerrk.view.JRHyperlinkListener} interface and add an instance
 * of this listener class to register with the viewer component, using the 
 * {@link com.github.exerrk.swing.JRViewer#addHyperlinkListener(JRHyperlinkListener) addHyperlinkListener(JRHyperlinkListener)} method exposed by the
 * {@link com.github.exerrk.swing.JRViewer} class. By doing this, you ensure that the
 * viewer will also call the implementation of the 
 * {@link com.github.exerrk.swing.JRViewer#gotoHyperlink(com.github.exerrk.engine.JRPrintHyperlink) gotoHyperlink(JRPrintHyperlink)} method in which
 ...
 * {@link com.github.exerrk.swing.JRViewer#VIEWER_RENDER_BUFFER_MAX_SIZE com.github.exerrk.viewer.render.buffer.max.size} configuration property.
 * The value of this property represents the maximum size (in pixels) of a buffered image 
 * that would be used by the {@link com.github.exerrk.swing.JRViewer} component to render
 ...
 * 
 * @see com.github.exerrk.view.JRHyperlinkListener
 */
