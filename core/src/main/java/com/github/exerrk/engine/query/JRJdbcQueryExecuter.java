...
import com.github.exerrk.engine.JRResultSetDataSource;
...
public class JRJdbcQueryExecuter extends JRAbstractQueryExecuter
{
	...
	/* (non-Javadoc)
	 * @see com.github.exerrk.engine.util.JRQueryExecuter#createDatasource()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.github.exerrk.engine.util.JRQueryExecuter#close()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.github.exerrk.engine.util.JRQueryExecuter#cancelQuery()
	 */
	@Override
