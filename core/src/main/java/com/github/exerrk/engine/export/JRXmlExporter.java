...
import com.github.exerrk.engine.xml.XmlValueHandlerUtils;
...
import com.github.exerrk.export.XmlExporterOutput;
 ...
 * {@link com.github.exerrk.engine.JasperPrint} object, but in XML format, instead
 ...
 * object using the {@link com.github.exerrk.engine.xml.JRPrintXmlLoader} utility class.
 ...
 * into a {@link com.github.exerrk.engine.JasperPrint} object that will look the same as the original one.
 * <p/>
 * The built-in viewers can display documents exported in JRPXML format because they
 * actually rely on the {@link com.github.exerrk.engine.xml.JRPrintXmlLoader} to load the
 * document back into a {@link com.github.exerrk.engine.JasperPrint} object before
 ...
 * {@link com.github.exerrk.export.XmlExporterOutput#isEmbeddingImages() isEmbeddingImages()}
 ...
 * @see com.github.exerrk.engine.xml.JRPrintXmlLoader
...
//	protected Map fontsMap = new HashMap();
	...
	protected void ensureOutput()
	{
		...
		{
			exporterOutput = 
				new com.github.exerrk.export.parameters.ParametersXmlExporterOutput(
