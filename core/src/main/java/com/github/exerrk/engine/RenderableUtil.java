...
import com.github.exerrk.renderers.WrappingDataToGraphics2DRenderer;
import com.github.exerrk.renderers.WrappingDeprecatedRenderable;
import com.github.exerrk.renderers.WrappingRenderToImageDataRenderer;
...
public class RenderableUtil
{
	 ...
	 * @deprecated To be removed.
	 */
	public com.github.exerrk.renderers.Renderable getOnErrorRendererForDimension(
		RenderersCache renderersCache,
		com.github.exerrk.renderers.Renderable renderer,
		OnErrorTypeEnum onErrorType
		) throws JRException
	{
		com.github.exerrk.renderers.Renderable result = null;
		...
		if (dimensionRenderer != null)
		{
			try
			{
				...
				result = (com.github.exerrk.renderers.Renderable)dimensionRenderer;
			}
			catch (Exception e)
			{
				result = handleImageError(e, onErrorType);
	...
	public static Renderable getWrappingRenderable(JRRenderable deprecatedRenderer)
	{
		...
		if (deprecatedRenderer != null)
		{
			...
			if (renderable == null)
			{
				renderable = new com.github.exerrk.engine.util.WrappingRenderable(deprecatedRenderer);
			}
		}
		return renderable;
	}
	...
	public static Renderable getWrappingRenderable(JRImageMapRenderer deprecatedRenderer)
	{
		...
		if (deprecatedRenderer != null)
		{
			...
			if (renderable == null)
			{
				renderable = new com.github.exerrk.engine.util.WrappingImageMapRenderable(deprecatedRenderer);
			}
		}
		return renderable;
	}
	 ...
	 * @deprecated To be removed.
	 */
	public static Renderable getWrappingRenderable(com.github.exerrk.renderers.Renderable renderable)
	{
