...
import com.github.exerrk.engine.JRPrintElementIndex;
...
import com.github.exerrk.engine.export.ElementGridCell;
import com.github.exerrk.engine.export.ExporterNature;
import com.github.exerrk.engine.export.GenericElementHandlerEnviroment;
import com.github.exerrk.engine.export.Grid;
import com.github.exerrk.engine.export.GridRow;
import com.github.exerrk.engine.export.HyperlinkUtil;
import com.github.exerrk.engine.export.JRExportProgressMonitor;
import com.github.exerrk.engine.export.JRExporterGridCell;
import com.github.exerrk.engine.export.JRGridLayout;
import com.github.exerrk.engine.export.JRHyperlinkProducer;
import com.github.exerrk.engine.export.JRXmlExporter;
import com.github.exerrk.engine.export.LengthUtil;
import com.github.exerrk.engine.export.OccupiedGridCell;
...
import com.github.exerrk.engine.util.JRTypeSniffer;
import com.github.exerrk.export.DocxExporterConfiguration;
 ...
 * exporter instance (see {@link com.github.exerrk.export.DocxReportConfiguration}):
 * <ul>
 * <li>Forcing the use of nested tables to render the content of frame elements using either
 * the {@link com.github.exerrk.export.DocxReportConfiguration#isFramesAsNestedTables() isFramesAsNestedTables()}
 * exporter configuration flag or its corresponding exporter hint called
 * {@link com.github.exerrk.export.DocxReportConfiguration#PROPERTY_FRAMES_AS_NESTED_TABLES com.github.exerrk.export.docx.frames.as.nested.tables}.</li>
 ...
 * {@link com.github.exerrk.export.DocxReportConfiguration#isFlexibleRowHeight() isFlexibleRowHeight()}
 * exporter configuration flag, or its corresponding exporter hint called
 * {@link com.github.exerrk.export.DocxReportConfiguration#PROPERTY_FLEXIBLE_ROW_HEIGHT com.github.exerrk.export.docx.flexible.row.height}.</li>
 ...
 * {@link com.github.exerrk.export.DocxReportConfiguration#isIgnoreHyperlink() isIgnoreHyperlink()}
 * exporter configuration flag, or its corresponding exporter hint called
 * {@link com.github.exerrk.export.DocxReportConfiguration#PROPERTY_IGNORE_HYPERLINK com.github.exerrk.export.docx.ignore.hyperlink}</li>
 * </ul>
 * 
 * @see com.github.exerrk.export.DocxReportConfiguration
...
//		hyperlinksMap = new HashMap();
	...
	protected void exportReportToStream(OutputStream os) throws JRException, IOException
	{
		...
		if( application == null )
		{
			application = "JasperReports Library version " + Package.getPackage("com.github.exerrk.engine").getImplementationVersion();
		}
