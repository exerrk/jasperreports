...
public abstract class AbstractXlsQueryExecuterFactory extends AbstractQueryExecuterFactory implements Designated 
{
	 ...
	 * <code>com.github.exerrk.xls.column.names.{arbitrary_name}=value1[, value2, ...]</code>
	 */
	@Property(
			name = "com.github.exerrk.xls.column.names.{arbitrary_name}",
			category = PropertyConstants.CATEGORY_DATA_SOURCE,
			scopes = {PropertyScope.CONTEXT, PropertyScope.DATASET},
			scopeQualifications = {QUERY_EXECUTER_NAME},
			sinceVersion = PropertyConstants.VERSION_5_5_2
	 ...
	 * <code>com.github.exerrk.xls.column.indexes.{arbitrary_name}=value1[, value2, ...]</code>
	 */
	@Property(
			name = "com.github.exerrk.xls.column.indexes.{arbitrary_name}",
			category = PropertyConstants.CATEGORY_DATA_SOURCE,
			scopes = {PropertyScope.CONTEXT, PropertyScope.DATASET},
			scopeQualifications = {QUERY_EXECUTER_NAME},
			sinceVersion = PropertyConstants.VERSION_5_5_2
