 ...
 * <p/>
 * The factory creates {@link com.github.exerrk.engine.query.JRHibernateQueryExecuter JRHibernateQueryExecuter}
 * query executers. 
 * 
...
public class JRHibernateQueryExecuterFactory extends AbstractQueryExecuterFactory implements Designated
{
	...
	public static final String QUERY_EXECUTER_NAME = "com.github.exerrk.query.executer:HQL";
	 ...
	 * <p/>
	 * @see com.github.exerrk.engine.query.JRHibernateQueryExecuterFactory#PROPERTY_HIBERNATE_QUERY_LIST_PAGE_SIZE
	 */
	@Property(
			category = PropertyConstants.CATEGORY_DATA_SOURCE,
