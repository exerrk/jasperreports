...
import com.github.exerrk.engine.export.DefaultHyperlinkProducerFactory;
import com.github.exerrk.engine.export.ExporterFilter;
import com.github.exerrk.engine.export.ExporterFilterFactory;
import com.github.exerrk.engine.export.ExporterFilterFactoryUtil;
import com.github.exerrk.engine.export.JRExporterContext;
import com.github.exerrk.engine.export.JRHyperlinkProducer;
import com.github.exerrk.engine.export.JRHyperlinkProducerFactory;
import com.github.exerrk.engine.export.data.BooleanTextValue;
import com.github.exerrk.engine.export.data.DateTextValue;
import com.github.exerrk.engine.export.data.NumberTextValue;
import com.github.exerrk.engine.export.data.StringTextValue;
import com.github.exerrk.engine.export.data.TextValue;
import com.github.exerrk.engine.fonts.FontUtil;
import com.github.exerrk.engine.util.DefaultFormatFactory;
import com.github.exerrk.engine.util.FileResolver;
...
import com.github.exerrk.engine.util.JRStyledTextUtil;
import com.github.exerrk.engine.util.LocalJasperReportsContext;
import com.github.exerrk.engine.util.Pair;
import com.github.exerrk.export.CompositeExporterConfigurationFactory;
...
import com.github.exerrk.export.PropertiesDefaultsConfigurationFactory;
import com.github.exerrk.export.PropertiesNoDefaultsConfigurationFactory;
import com.github.exerrk.export.ReportExportConfiguration;
import com.github.exerrk.export.SimpleExporterInputItem;
...
public abstract class JRAbstractExporter<RC extends ReportExportConfiguration, C extends ExporterConfiguration, O extends ExporterOutput, E extends JRExporterContext> implements JRExporter<ExporterInput, RC, C, O>
{
	 ...
	 * <code>com.github.exerrk.export.xls.default.filter.factory</code>.
	 * 
	 ...
	 */
	@Property(
			name = "com.github.exerrk.export.{arbitrary_name}.default.filter.factory",
			valueType = Class.class,
			category = PropertyConstants.CATEGORY_EXPORT,
			defaultValue = "same default value as for com.github.exerrk.export.default.filter.factory",
	...
	@Property(
			category = PropertyConstants.CATEGORY_EXPORT,
			valueType = Class.class,
			defaultValue = "com.github.exerrk.engine.export.DefaultExporterFilterFactory",
	...
	protected RC getCurrentItemConfiguration()
	{
		if (crtCompositeItemConfiguration == null)
		{
			...
			if (useOldApi)
			{
				@SuppressWarnings("deprecation")
				RC depConf = 
					new com.github.exerrk.export.parameters.ParametersExporterConfigurationFactory<RC>(
	...
	protected C getCurrentConfiguration()
	{
		if (crtCompositeConfiguration == null)
		{
			if (useOldApi)
			{
				@SuppressWarnings("deprecation")
				C depConf = 
					new com.github.exerrk.export.parameters.ParametersExporterConfigurationFactory<C>(
						getJasperReportsContext(),
						getParameters(),
						getCurrentJasperPrint()
						).getConfiguration(
	...
	protected void ensureInput()
	{
		...
		{
			exporterInput = new com.github.exerrk.export.parameters.ParametersExporterInput(parameters);
		}
