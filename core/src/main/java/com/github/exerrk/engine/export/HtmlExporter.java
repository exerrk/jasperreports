...
import com.github.exerrk.engine.JRPrintImageArea;
...
import com.github.exerrk.engine.PrintElementId;
...
import com.github.exerrk.engine.export.tabulator.Cell;
import com.github.exerrk.engine.export.tabulator.CellVisitor;
import com.github.exerrk.engine.export.tabulator.Column;
import com.github.exerrk.engine.export.tabulator.ElementCell;
import com.github.exerrk.engine.export.tabulator.FrameCell;
import com.github.exerrk.engine.export.tabulator.LayeredCell;
import com.github.exerrk.engine.export.tabulator.Row;
import com.github.exerrk.engine.export.tabulator.SplitCell;
import com.github.exerrk.engine.export.tabulator.Table;
import com.github.exerrk.engine.export.tabulator.TableCell;
import com.github.exerrk.engine.export.tabulator.TablePosition;
import com.github.exerrk.engine.export.tabulator.Tabulator;
...
import com.github.exerrk.engine.util.HyperlinkData;
...
import com.github.exerrk.export.HtmlExporterConfiguration;
import com.github.exerrk.export.HtmlReportConfiguration;
import com.github.exerrk.properties.PropertyConstants;
import com.github.exerrk.renderers.AreaHyperlinksRenderable;
...
import com.github.exerrk.renderers.util.SvgDataSniffer;
import com.github.exerrk.renderers.util.SvgFontProcessor;
import com.github.exerrk.search.HitTermInfo;
import com.github.exerrk.search.SpansInfo;
import com.github.exerrk.util.Base64Util;
...
public class HtmlExporter extends AbstractHtmlExporter<HtmlReportConfiguration, HtmlExporterConfiguration>
{
	...
	protected void ensureOutput()
	{
		...
		{
			exporterOutput = 
				new com.github.exerrk.export.parameters.ParametersHtmlExporterOutput(
	...
	protected void exportReportToWriter() throws JRException, IOException
	{
		...
		if (hyperlinksData.size() > 0) 
		{
			...
			reportContext.setParameterValue("com.github.exerrk.html.hyperlinks", hyperlinksData);
		}
...
//			String textTooltip = hyperlinkStarted ? null : text.getHyperlinkTooltip();
	...
	private void addSearchAttributes(JRStyledText styledText, JRPrintText textElement) {
		ReportContext reportContext = getReportContext();
		if (reportContext != null) {
			SpansInfo spansInfo = (SpansInfo) reportContext.getParameterValue("com.github.exerrk.search.term.highlighter");
