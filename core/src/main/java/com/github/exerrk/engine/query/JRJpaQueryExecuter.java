...
import com.github.exerrk.engine.data.JRJpaDataSource;
 ...
 * When running or filling reports the <code>em</code> need to be supplied with the named parameter {@link com.github.exerrk.engine.query.JRJpaQueryExecuterFactory#PARAMETER_JPA_ENTITY_MANAGER}.
 * <p/>
 * Example:
 * <code>
 * <pre>
 ...
 * </code>
 * <p/>
 * When dealing with large result sets, pagination can be used by setting the {@link com.github.exerrk.engine.query.JRJpaQueryExecuterFactory#PROPERTY_JPA_QUERY_PAGE_SIZE} property in the report template.
 * <p/>
 * Example:
 * <code>
 * <pre>
 * &lt;property name="com.github.exerrk.ejbql.query.page.size" value="100"/&gt;
 * </pre>
 * </code>
 * <p/>
 * Implementation-specific query hints can be set either using report properties in the report template,
 * or by supplying the named parameter {@link com.github.exerrk.engine.query.JRJpaQueryExecuterFactory#PARAMETER_JPA_QUERY_HINTS_MAP}
 * containing a <code>java.util.Map</code> with named/value query hints.
 * <p/>
 * Example using report property:
 * <code>
 * <pre>
 * &lt;property name="com.github.exerrk.ejbql.query.hint.fetchSize" value="100"/&gt;
 * </pre>
 * </code>
 * The name of the query hint need to be prefixed with {@link com.github.exerrk.engine.query.JRJpaQueryExecuterFactory#PROPERTY_JPA_QUERY_HINT_PREFIX com.github.exerrk.ejbql.query.hint.}.
 ...
 * @see com.github.exerrk.engine.query.JRJpaQueryExecuterFactory
 */
public class JRJpaQueryExecuter extends JRAbstractQueryExecuter 
{
	...
	protected synchronized void createQuery(String queryString) {
		...
		// Example: com.github.exerrk.ejbql.query.hint.fetchSize
