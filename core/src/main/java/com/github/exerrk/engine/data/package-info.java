 ...
 * {@link com.github.exerrk.engine.JRDataSource JRDataSource} object as the data source of the
 ...
 * The {@link com.github.exerrk.engine.JRDataSource JRDataSource} interface is very simple. It
 ...
 * {@link com.github.exerrk.engine.JRDataSource JRDataSource} interface.
 * </p>
 * <h3>JDBC Data Sources</h3>
 * The {@link com.github.exerrk.engine.JRResultSetDataSource JRResultSetDataSource} is a very useful
 * implementation of the {@link com.github.exerrk.engine.JRDataSource JRDataSource} interface
 ...
 * {@link com.github.exerrk.engine.JRResultSetDataSource JRResultSetDataSource} instance. The only thing
 ...
 * <p>
 * The {@link com.github.exerrk.engine.data.JRBeanArrayDataSource JRBeanArrayDataSource} is for
 * wrapping an array of JavaBean objects to use for filling a report with data, and the 
 * {@link com.github.exerrk.engine.data.JRBeanCollectionDataSource JRBeanCollectionDataSource} is for
 ...
 * <p>
 * The {@link com.github.exerrk.engine.data.JRMapArrayDataSource JRMapArrayDataSource} wraps an array
 * of <code>java.util.Map</code> objects, and 
 * {@link com.github.exerrk.engine.data.JRMapCollectionDataSource JRMapCollectionDataSource} can be used
 ...
 * {@link com.github.exerrk.engine.data.JRTableModelDataSource JRTableModelDataSource} instance before
 ...
 * ({@link com.github.exerrk.engine.data.JRXmlDataSource JRXmlDataSource}) that is based on DOM
 ...
 * for each record is needed. The field's XPath expression is provided by the {@link com.github.exerrk.engine.data.AbstractXmlDataSource#PROPERTY_FIELD_EXPRESSION}
 * custom field property. The use of the {@link com.github.exerrk.engine.JRField#getDescription() field description} to specify the XPath expression
 ...
 * {@link com.github.exerrk.engine.util.xml.JRXPathExecuter JRXPathExecuter}.
 * </p><p> 
 * The XPath executer implementation used by XML data sources can be configured via a 
 * JasperReports property named {@link com.github.exerrk.engine.util.xml.JRXPathExecuterUtils#PROPERTY_XPATH_EXECUTER_FACTORY com.github.exerrk.xpath.executer.factory}.
 * This property gives the name of a XPath executer factory class, which has to implement 
 * the {@link com.github.exerrk.engine.util.xml.JRXPathExecuterFactory JRXPathExecuterFactory}.
 ...
 * {@link com.github.exerrk.engine.util.xml.JRXPathExecuterUtils#PROPERTY_XPATH_EXECUTER_FACTORY com.github.exerrk.xpath.executer.factory} property to
 * {@link com.github.exerrk.engine.util.xml.JaxenXPathExecuterFactory JaxenXPathExecuterFactory}, which
 * is usually done by including the following line in the jasperreports.properties 
 * configuration file: 
 * <pre>
 * com.github.exerrk.xpath.executer.factory=com.github.exerrk.engine.util.xml.JaxenXPathExecuterFactory
 * </pre> 
 * To switch back to Xalan, one would comment or remove the property line, or explicitly set the property to 
 * {@link com.github.exerrk.engine.util.xml.XalanXPathExecuterFactory XalanXPathExecuterFactory}.
 * </p>
 ...
 * data from a text file into a {@link com.github.exerrk.engine.data.JRCsvDataSource JRCsvDataSource}.
 * The CSV data source usually needs to read a file from disk, or at least from an input 
 * stream. Thus, the {@link com.github.exerrk.engine.data.JRCsvDataSource JRCsvDataSource} can be initialized in three ways, depending on
 ...
 * {@link com.github.exerrk.engine.data.JRCsvDataSource JRCsvDataSource} instance by calling its
 ...
 * {@link com.github.exerrk.engine.data.ExcelDataSource ExcelDataSource} data source
 ...
 * The {@link com.github.exerrk.engine.JREmptyDataSource JREmptyDataSource} class is a very simple
 ...
 * The {@link com.github.exerrk.engine.JRRewindableDataSource JRRewindableDataSource} is an extension of
 * the basic {@link com.github.exerrk.engine.JRDataSource JRDataSource}interface, to which it adds
 ...
 * {@link com.github.exerrk.engine.JRResultSetDataSource JRResultSetDataSource}, which does not support
 ...
 * {@link com.github.exerrk.engine.JRDataSourceProvider JRDataSourceProvider} interface and make it
 ...
 * {@link com.github.exerrk.engine.JRDataSourceProvider JRDataSourceProvider}
 ...
 * </p><p>
 * The {@link com.github.exerrk.engine.data.JRAbstractBeanDataSourceProvider JRAbstractBeanDataSourceProvider}
