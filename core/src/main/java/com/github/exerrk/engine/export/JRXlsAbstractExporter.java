...
import com.github.exerrk.export.PrintPartUnrollExporterInput;
import com.github.exerrk.export.ReportExportConfiguration;
import com.github.exerrk.export.XlsExporterConfiguration;
import com.github.exerrk.export.XlsReportConfiguration;
 ...
 * {@link com.github.exerrk.engine.export.JRXlsExporter} implementation, which
 ...
 * {@link com.github.exerrk.engine.export.ooxml.JRXlsxExporter}; it does not rely
 ...
 * to put all pages inside the source {@link com.github.exerrk.engine.JasperPrint} document
 ...
 * {@link com.github.exerrk.export.XlsReportConfiguration#isOnePagePerSheet() isOnePagePerSheet()}
 * exporter configuration setting, which is set to <code>Boolean.FALSE</code> by default.
 * <p/>
 * When {@link com.github.exerrk.export.XlsReportConfiguration#isOnePagePerSheet() isOnePagePerSheet()}
 ...
 * of rows per sheet for {@link com.github.exerrk.export.XlsReportConfiguration#PROPERTY_MAXIMUM_ROWS_PER_SHEET com.github.exerrk.export.xls.max.rows.per.sheet} property and
 * set true for {@link com.github.exerrk.export.XlsReportConfiguration#PROPERTY_ONE_PAGE_PER_SHEET com.github.exerrk.export.xls.one.page.per.sheet} property.
 * <p/>
 * The JasperReports Excel exporters provide a simple but efficient sheet-naming
 * mechanism. They use the {@link com.github.exerrk.export.XlsReportConfiguration#getSheetNames() getSheetNames()}
 ...
 * {@link com.github.exerrk.export.XlsReportConfiguration#PROPERTY_SHEET_NAMES_PREFIX com.github.exerrk.export.xls.sheet.names.&lt;arbitrary_name&gt;} property
 * at report level. Add the following to the JRXML file:
 * <pre>
 * &lt;property name="com.github.exerrk.export.xls.sheet.names.all" value="Sheet A/Sheet B/Sheet C" /&gt;
 * </pre>
 * Keep in mind the naming order is important, sheets will be named in the same order the names are 
 * provided in this property. 
 * <p/>
 * Sheets can be also named at element level, using the {@link #PROPERTY_SHEET_NAME com.github.exerrk.export.xls.sheet.name}
 ...
 * {@link com.github.exerrk.export.XlsReportConfiguration#isRemoveEmptySpaceBetweenRows() isRemoveEmptySpaceBetweenRows()}
 ...
 * {@link com.github.exerrk.engine.JRParameter#IS_IGNORE_PAGINATION IS_IGNORE_PAGINATION}.
 * You can modify the API to remove the empty space between rows and columns as well.
 * You need to set {@link com.github.exerrk.export.XlsReportConfiguration#PROPERTY_REMOVE_EMPTY_SPACE_BETWEEN_ROWS com.github.exerrk.export.xls.remove.empty.space.between.rows}
 * property and/or {@link com.github.exerrk.export.XlsReportConfiguration#PROPERTY_REMOVE_EMPTY_SPACE_BETWEEN_COLUMNS com.github.exerrk.export.xls.remove.empty.space.between.columns}
 * property to true.
 * <p/>
 ...
 * {@link com.github.exerrk.export.XlsReportConfiguration#PROPERTY_REMOVE_EMPTY_SPACE_BETWEEN_ROWS com.github.exerrk.export.xls.remove.empty.space.between.rows} property and/or
 * {@link com.github.exerrk.export.XlsReportConfiguration#PROPERTY_REMOVE_EMPTY_SPACE_BETWEEN_COLUMNS com.github.exerrk.export.xls.remove.empty.space.between.columns} property to
 * true, the empty spaces are removed.
 * <h3>Cell Types</h3>
 * Inside the proprietary document format that JasperReports uses (represented by the
 * {@link com.github.exerrk.engine.JasperPrint} object), all text elements are
 ...
 * the text elements inside the {@link com.github.exerrk.engine.JasperPrint} object
 ...
 * {@link com.github.exerrk.export.XlsReportConfiguration#isDetectCellType() isDetectCellType()}
 ...
 * {@link com.github.exerrk.export.XlsReportConfiguration#PROPERTY_DETECT_CELL_TYPE com.github.exerrk.export.xls.detect.cell.type} property to true. When you do this, instead
 ...
 * {@link com.github.exerrk.export.XlsReportConfiguration#getFormatPatternsMap() getFormatPatternsMap()}
 ...
 * {@link #PROPERTY_CELL_PATTERN com.github.exerrk.export.xls.pattern} property at element level.
 ...
 * {@link com.github.exerrk.export.XlsReportConfiguration#isFontSizeFixEnabled() isFontSizeFixEnabled()}
 * exporter configuration flag to decrease the font size by one point when generating the cell format.
 * Alternatively, one can use the {@link com.github.exerrk.export.XlsReportConfiguration#PROPERTY_FONT_SIZE_FIX_ENABLED com.github.exerrk.export.xls.font.size.fix.enabled}
 * property at report level.
 * <h3>Background Color</h3>
 * Empty space found on each page in the source {@link com.github.exerrk.engine.JasperPrint}
 ...
 * to be white, set the 
 * {@link com.github.exerrk.export.XlsReportConfiguration#isWhitePageBackground() isWhitePageBackground()}
 ...
 * {@link com.github.exerrk.export.XlsExporterConfiguration#isCreateCustomPalette() isCreateCustomPalette()}
 ...
 * {@link com.github.exerrk.export.XlsReportConfiguration} and
 * {@link com.github.exerrk.export.XlsExporterConfiguration} classes.
 * 
 * @see com.github.exerrk.export.XlsExporterConfiguration
 * @see com.github.exerrk.export.XlsReportConfiguration
	...
	extends JRAbstractExporter<RC, C, OutputStreamExporterOutput, E>
{
	 ...
	 * <br/>
	 * In such a case, the {@link #PROPERTY_ROW_OUTLINE_LEVEL_PREFIX com.github.exerrk.export.xls.outline.level.2} property means that its value is correlated with
	 ...
	 */
	@Property(
			name = "com.github.exerrk.export.xls.row.outline.level.{arbitrary_level}",
			category = PropertyConstants.CATEGORY_EXPORT,
			scopes = {PropertyScope.ELEMENT},
			sinceVersion = PropertyConstants.VERSION_4_1_3
			)
