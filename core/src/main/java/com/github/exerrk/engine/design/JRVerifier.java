...
import com.github.exerrk.crosstabs.fill.JRPercentageCalculator;
import com.github.exerrk.crosstabs.fill.JRPercentageCalculatorFactory;
...
import com.github.exerrk.engine.JRTemplate;
...
import com.github.exerrk.engine.part.PartComponentCompiler;
...
//								);
	...
	private void verifyCrosstabMeasure(JRCrosstabMeasure measure)
	{
		...
		try
		{
			...
			{
				addBrokenRule("Crosstab measures need extended incrementers (com.github.exerrk.engine.fill.JRExtendedIncrementerFactory).", measure);
			}
		}
		catch (JRRuntimeException e)
		{
