 ...
 * <p/>
 * The factory creates {@link com.github.exerrk.engine.query.XalanXPathQueryExecuter XalanXPathQueryExecuter}
 * query executers.
 * 
...
public class XalanXPathQueryExecuterFactory extends JRXPathQueryExecuterFactory
{
	 ...
	 * e.g. com.github.exerrk.xml.namespace.{prefix} = uri
	 * <p>
	 ...
	 */
	@Property(
			name="com.github.exerrk.xml.namespace.{arbitrary_prefix}",
