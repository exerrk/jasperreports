...
import com.github.exerrk.engine.data.JaxenXmlDataSource;

/**
 * Jaxen XPath query executer implementation.
 * <p/>
 * The XPath query of the report is executed against the document specified by the
 * {@link com.github.exerrk.engine.query.JaxenXPathQueryExecuterFactory#PARAMETER_XML_DATA_DOCUMENT PARAMETER_XML_DATA_DOCUMENT}
 * parameter.
 * <p/>
