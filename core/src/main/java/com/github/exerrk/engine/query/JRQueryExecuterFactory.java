 ...
 * @see com.github.exerrk.engine.query.JRQueryExecuter
...
public interface JRQueryExecuterFactory
{
	 ...
	 * @throws JRException
	 * @deprecated Replaced by {@link QueryExecuterFactory#createQueryExecuter(com.github.exerrk.engine.JasperReportsContext, JRDataset, Map)}.
	 */
