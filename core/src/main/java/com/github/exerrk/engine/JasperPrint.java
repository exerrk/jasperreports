...
import com.github.exerrk.engine.base.StandardPrintParts;
...
public class JasperPrint implements Serializable, JRPropertiesHolder
{
	 ...
	 */
	@Property(
			name = "com.github.exerrk.print.transfer.{arbitrary_suffix}",
	...
	/**
	 * Returns the name of the class implementing the {@link com.github.exerrk.engine.util.FormatFactory FormatFactory}
	...
	/**
	 * Sets the name of the class implementing the {@link com.github.exerrk.engine.util.FormatFactory FormatFactory}
	 * interface to use with this document.
	 */
