 ...
 * (see {@link com.github.exerrk.engine.JRCommonImage}) and the actual image is smaller
 ...
 * <li><code>{@link com.github.exerrk.renderers.Renderable}</code></li>
 * </ul>
 ...
 * {@link com.github.exerrk.engine.JREvaluation}, are available in the <code>&lt;image&gt;</code> element.
