 ...
 * {@link com.github.exerrk.engine.JRDataSource} object as the report data source, but
 ...
 * {@link com.github.exerrk.engine.JRDataSource} object when filling the report.
 * </p><p>
 ...
 * {@link com.github.exerrk.engine.design.JRDesignQuery#setLanguage(String) setLanguage(String)}. The default language is SQL, thus ensuring
 ...
 * {@link com.github.exerrk.engine.query.QueryExecuterFactory#QUERY_EXECUTER_FACTORY_PREFIX com.github.exerrk.query.executer.factory.&lt;language&gt;}. The same mechanism can be used to
 ...
 * interface, implementations of these interfaces, and {@link com.github.exerrk.engine.JRDataSource} implementations.
 * </p><p>
 * {@link com.github.exerrk.engine.query.QueryExecuterFactory} is a factory interface used to query executers for a specific
 ...
 * </ul>
 * A {@link com.github.exerrk.engine.query.JRQueryExecuter} is responsible for running a query, creating a
 ...
 * {@link com.github.exerrk.engine.query.JRAbstractQueryExecuter} as
 * a base. The abstract base provides query parameter processing functionality and other 
 * utility methods. 
 * </p><p>
 * In most cases, a query executer needs a new {@link com.github.exerrk.engine.JRDataSource}
 * implementation to wrap its specific query results. Still, in some of the cases, query executers 
 * can use existing {@link com.github.exerrk.engine.JRDataSource} implementations.
 * </p><p>
 ...
 * {@link com.github.exerrk.engine.query.QueryExecuterFactoryBundle} interface.
 * </p>
 ...
 * {@link com.github.exerrk.engine.JRParameter#REPORT_CONNECTION REPORT_CONNECTION} parameter
 ...
 * The query executer creates a {@link com.github.exerrk.engine.JRResultSetDataSource} data source to wrap the JDBC
 * result set. 
 * </p><p>
 ...
 * {@link com.github.exerrk.engine.query.JRJdbcQueryExecuterFactory#PROPERTY_JDBC_FETCH_SIZE com.github.exerrk.jdbc.fetch.size} configuration property at report level or
 * globally.
 * </p>
 ...
 * {@link com.github.exerrk.engine.query.JRXPathQueryExecuterFactory#PARAMETER_XML_DATA_DOCUMENT XML_DATA_DOCUMENT}
 * of type <code>org.w3c.dom.Document</code>. The query executer will run the XPath query against this 
 * document and produce a {@link com.github.exerrk.engine.data.JRXmlDataSource} data source.
 * </p><p>
 ...
 * purposes when creating the {@link com.github.exerrk.engine.data.JRXmlDataSource} instance:
 * <ul>
 * <li>{@link com.github.exerrk.engine.query.JRXPathQueryExecuterFactory#XML_LOCALE XML_LOCALE}</li>
 * <li>{@link com.github.exerrk.engine.query.JRXPathQueryExecuterFactory#XML_NUMBER_PATTERN XML_NUMBER_PATTERN}</li>
 * <li>{@link com.github.exerrk.engine.query.JRXPathQueryExecuterFactory#XML_DATE_PATTERN XML_DATE_PATTERN}</li>
 * </ul>
 * </p>
 ...
 * parameter named {@link com.github.exerrk.engine.query.JRHibernateQueryExecuterFactory#PARAMETER_HIBERNATE_SESSION HIBERNATE_SESSION}
 ...
 * {@link com.github.exerrk.engine.query.JRHibernateQueryExecuterFactory#PROPERTY_HIBERNATE_QUERY_RUN_TYPE com.github.exerrk.hql.query.run.type}. The run type can be one of the following:
 * <ul>
 ...
 * the {@link com.github.exerrk.engine.query.JRHibernateQueryExecuterFactory#PROPERTY_HIBERNATE_QUERY_LIST_PAGE_SIZE com.github.exerrk.hql.query.list.page.size}
 ...
 * This is why the {@link com.github.exerrk.engine.query.JRHibernateQueryExecuterFactory#PROPERTY_HIBERNATE_CLEAR_CACHE com.github.exerrk.hql.clear.cache} property was introduced.
 ...
 * {@link com.github.exerrk.engine.query.JRHibernateQueryExecuterFactory#PROPERTY_HIBERNATE_FIELD_MAPPING_DESCRIPTIONS com.github.exerrk.hql.field.mapping.descriptions} configuration
 ...
 * {@link com.github.exerrk.olap.JRMondrianQueryExecuterFactory#PARAMETER_MONDRIAN_CONNECTION MONDRIAN_CONNECTION}
 ...
 * </p><p>
 * The Mondrian query executer passes the query result to a {@link com.github.exerrk.olap.JRMondrianDataSource}, which
 ...
 * {@link com.github.exerrk.olap.JRMdxQueryExecuterFactory} class that is registered by default
 ...
 * the {@link com.github.exerrk.olap.JRMondrianQueryExecuterFactory} or the
 * {@link com.github.exerrk.olap.xmla.JRXmlaQueryExecuterFactory},
 ...
 * then checks for the {@link com.github.exerrk.olap.xmla.JRXmlaQueryExecuterFactory#PARAMETER_XMLA_URL PARAMETER_XMLA_URL}
 ...
 * {@link com.github.exerrk.engine.query.JRJpaQueryExecuterFactory#PARAMETER_JPA_ENTITY_MANAGER JPA_ENTITY_MANAGER}
 * built-in parameter: 
 * <pre>
 ...
 * {@link com.github.exerrk.engine.query.JRJpaQueryExecuterFactory#PARAMETER_JPA_QUERY_HINTS_MAP JPA_QUERY_HINTS_MAP}
 ...
 * {@link com.github.exerrk.engine.query.JRJpaQueryExecuterFactory#PROPERTY_JPA_QUERY_HINT_PREFIX com.github.exerrk.ejbql.query.hint.&lt;hintName&gt;} as a hint by interpreting
 ...
 * </p><p>
 * <code>&lt;property name="com.github.exerrk.ejbql.query.hint.cacheType" value="Shared"/&gt;</code>
 * </p><p>
 ...
 * </p><p>
 * <code>&lt;property name="com.github.exerrk.ejbql.query.page.size" value="500"/&gt;</code>
 * </p><p>
 ...
 * {@link com.github.exerrk.engine.data.JRJpaDataSource}
 ...
 * @see com.github.exerrk.engine.JRDataSource
 * @see com.github.exerrk.engine.JRResultSetDataSource
 * @see com.github.exerrk.engine.data.JRJpaDataSource
 * @see com.github.exerrk.engine.data.JRXmlDataSource
 * @see com.github.exerrk.olap.JRMdxQueryExecuterFactory
 * @see com.github.exerrk.olap.JRMondrianDataSource
 * @see com.github.exerrk.olap.JRMondrianQueryExecuterFactory
 * @see com.github.exerrk.olap.xmla.JRXmlaQueryExecuterFactory
 */
