 ...
 * <p/>
 * The factory creates {@link com.github.exerrk.engine.query.JRJpaQueryExecuter JRJpaQueryExecuter}
 * query executers. 
 * 
...
public class JRJpaQueryExecuterFactory extends AbstractQueryExecuterFactory implements Designated 
{
	...
	public static final String QUERY_EXECUTER_NAME = "com.github.exerrk.query.executer:EJBQL";
	 ...
	 */
	@Property(
			name = "com.github.exerrk.ejbql.query.hint.{hint}",
			category = PropertyConstants.CATEGORY_DATA_SOURCE,
