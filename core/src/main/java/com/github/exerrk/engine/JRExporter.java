...
public interface JRExporter<I extends ExporterInput, IC extends ReportExportConfiguration, C extends ExporterConfiguration, O extends ExporterOutput> extends Exporter<I, IC, C, O>
{
	 ...
	 * @deprecated Replaced by  {@link #setExporterInput(com.github.exerrk.export.ExporterInput)},
	 * {@link #setConfiguration(ExporterConfiguration)} and {@link #setExporterOutput(com.github.exerrk.export.ExporterOutput)}
	 */
