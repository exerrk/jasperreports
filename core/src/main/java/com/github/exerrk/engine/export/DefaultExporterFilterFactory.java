...
public class DefaultExporterFilterFactory implements ExporterFilterFactory
{
	 ...
	 */
	@Property(
			name = "com.github.exerrk.export.filter.factory.{filter_element}",
	 ...
	 * {@link #PROPERTY_EXPORTER_FILTER_FACTORY_PREFIX com.github.exerrk.export.filter.factory.*} properties,
