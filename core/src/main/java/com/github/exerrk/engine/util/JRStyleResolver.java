...
import com.github.exerrk.charts.JRCategoryAxisFormat;
import com.github.exerrk.charts.JRTimeAxisFormat;
import com.github.exerrk.charts.JRValueAxisFormat;
import com.github.exerrk.charts.JRXAxisFormat;
import com.github.exerrk.charts.JRYAxisFormat;
import com.github.exerrk.engine.JRChart;
import com.github.exerrk.engine.JRChartPlot;
import com.github.exerrk.engine.JRCommonElement;
import com.github.exerrk.engine.JRCommonGraphicElement;
...
import com.github.exerrk.engine.JRTextAlignment;
import com.github.exerrk.engine.JRTextField;
import com.github.exerrk.engine.TabStop;
import com.github.exerrk.engine.base.JRBoxPen;
...
public final class JRStyleResolver
{
	 ...
	 */
	public static com.github.exerrk.engine.type.HorizontalAlignEnum getHorizontalAlignmentValue(com.github.exerrk.engine.JRAlignment alignment)
	{
		com.github.exerrk.engine.type.HorizontalAlignEnum ownHorizontalAlignment = alignment.getOwnHorizontalAlignmentValue();
		...
		if (baseStyle != null)
		{
			com.github.exerrk.engine.type.HorizontalAlignEnum horizontalAlignment = baseStyle.getHorizontalAlignmentValue();
			if (horizontalAlignment != null)
			{
				return horizontalAlignment;
			}
		}
		return com.github.exerrk.engine.type.HorizontalAlignEnum.LEFT;
	}
	 ...
	 */
	public static com.github.exerrk.engine.type.HorizontalAlignEnum getHorizontalAlignmentValue(JRStyle style)
	{
		com.github.exerrk.engine.type.HorizontalAlignEnum ownHorizontalAlignment = style.getOwnHorizontalAlignmentValue();
		if (ownHorizontalAlignment != null)
		{
			return ownHorizontalAlignment;
		}
	 ...
	 */
	public static com.github.exerrk.engine.type.VerticalAlignEnum getVerticalAlignmentValue(com.github.exerrk.engine.JRAlignment alignment)
	{
		com.github.exerrk.engine.type.VerticalAlignEnum ownVerticalAlignment = alignment.getOwnVerticalAlignmentValue();
		...
		if (baseStyle != null)
		{
			com.github.exerrk.engine.type.VerticalAlignEnum verticalAlignment = baseStyle.getVerticalAlignmentValue();
			if (verticalAlignment != null)
			{
				return verticalAlignment;
			}
		}
		return com.github.exerrk.engine.type.VerticalAlignEnum.TOP;
	}
	...
	{
		com.github.exerrk.engine.type.VerticalAlignEnum verticalAlignment = getVerticalAlignmentValue(style);
	 ...
	 */
	public static com.github.exerrk.engine.type.VerticalAlignEnum getVerticalAlignmentValue(JRStyle style)
	{
		com.github.exerrk.engine.type.VerticalAlignEnum ownVerticalAlignment = style.getOwnVerticalAlignmentValue();
		if (ownVerticalAlignment != null)
		{
			return ownVerticalAlignment;
		}
