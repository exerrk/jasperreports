...
public interface JRSaxParserFactory
{
	...
	@Property(
			...
			defaultValue = "com.github.exerrk.engine.xml.JRReportSaxParserFactory",
	...
	@Property(
			...
			defaultValue = "com.github.exerrk.engine.xml.PrintSaxParserFactory",
			scopes = {PropertyScope.CONTEXT},
	...
	@Property(
			category = PropertyConstants.CATEGORY_COMPILE,
			defaultValue = "com.github.exerrk.engine.xml.TemplateSaxParserFactory",
			scopes = {PropertyScope.CONTEXT},
