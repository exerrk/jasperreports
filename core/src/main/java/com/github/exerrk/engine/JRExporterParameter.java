...
public class JRExporterParameter
{
	 ...
	 * 
	 * @see com.github.exerrk.engine.util.JRResourcesUtil#createURL(String, java.net.URLStreamHandlerFactory)
	 * @deprecated Replaced by {@link JasperReportsContext}.
	 */
	...
	/**
	 * The {@link com.github.exerrk.engine.util.FileResolver FileResolver} instance to be used while exporting the report.
	 * @deprecated Replaced by {@link JasperReportsContext}.
	 */
