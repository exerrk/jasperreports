...
import com.github.exerrk.engine.analytics.data.AxisLevel;
import com.github.exerrk.engine.analytics.data.AxisLevel.Type;
import com.github.exerrk.engine.analytics.data.AxisLevelNode;
import com.github.exerrk.engine.analytics.data.MappedPropertyValues;
import com.github.exerrk.engine.analytics.data.Measure;
import com.github.exerrk.engine.analytics.data.MultiAxisDataSource;
import com.github.exerrk.engine.analytics.data.PropertyValues;
import com.github.exerrk.engine.analytics.data.StandardAxisLevel;
import com.github.exerrk.engine.analytics.data.StandardMeasure;
import com.github.exerrk.engine.analytics.data.StandardMeasureValue;
import com.github.exerrk.engine.fill.JRCalculator;
import com.github.exerrk.engine.fill.JRDefaultIncrementerFactory;
import com.github.exerrk.engine.fill.JRExpressionEvalException;
import com.github.exerrk.engine.fill.JRExtendedIncrementerFactory;
import com.github.exerrk.engine.fill.JRFillExpressionEvaluator;
import com.github.exerrk.engine.fill.JRIncrementerFactoryCache;
import com.github.exerrk.engine.util.SingleValue;
import com.github.exerrk.engine.util.ValuePropertiesWrapper;
import com.github.exerrk.engine.util.ValuePropertiesWrapperComparator;
...
public class MultiAxisDataService
{
	...
	protected class DataSource implements MultiAxisDataSource
	{
		...
		@Override
		public List<? extends com.github.exerrk.engine.analytics.data.MeasureValue> getMeasureValues(AxisLevelNode... nodes)
		{
			if (nodes.length == 0)
			{
			...
			List<com.github.exerrk.engine.analytics.data.MeasureValue> measureValues =
					new ArrayList<com.github.exerrk.engine.analytics.data.MeasureValue>(values.length);
