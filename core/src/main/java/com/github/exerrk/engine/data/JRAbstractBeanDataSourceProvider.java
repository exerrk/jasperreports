...
import com.github.exerrk.engine.JRDataSourceProvider;
...
import com.github.exerrk.engine.design.JRDesignField;
...
public abstract class JRAbstractBeanDataSourceProvider implements JRDataSourceProvider 
{
	...
	/**
	 * @see com.github.exerrk.engine.JRDataSourceProvider#supportsGetFieldsOperation()
	 */
	@Override
	...
	/**
	 * @see com.github.exerrk.engine.JRDataSourceProvider#getFields(com.github.exerrk.engine.JasperReport)
	 */
	@Override
