 ...
 * <p/>
 * The factory creates {@link com.github.exerrk.engine.query.JRCsvQueryExecuter JRCsvQueryExecuter}
 * query executers.
 * 
...
public class JRCsvQueryExecuterFactory extends AbstractQueryExecuterFactory implements Designated 
{
	...
	public static final String QUERY_EXECUTER_NAME = "com.github.exerrk.query.executer:CSV";
	 ...
	 * <code>com.github.exerrk.csv.column.names.{arbitrary_name}=value1[, value2, ...]</code>
	 */
	@Property(
			name = "com.github.exerrk.csv.column.names.{arbitrary_name}",
			category = PropertyConstants.CATEGORY_DATA_SOURCE,
			scopes = {PropertyScope.CONTEXT, PropertyScope.DATASET},
			scopeQualifications = {JRCsvQueryExecuterFactory.QUERY_EXECUTER_NAME},
			sinceVersion = PropertyConstants.VERSION_4_0_0
