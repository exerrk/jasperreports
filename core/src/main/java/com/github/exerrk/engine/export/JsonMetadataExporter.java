...
import com.github.exerrk.export.JsonExporterConfiguration;
import com.github.exerrk.export.JsonMetadataReportConfiguration;
...
public class JsonMetadataExporter extends JRAbstractExporter<JsonMetadataReportConfiguration, JsonExporterConfiguration, WriterExporterOutput, JsonExporterContext>
{
	...
	@Property(
			name = "com.github.exerrk.export.json.repeat.{path}",
			category = PropertyConstants.CATEGORY_EXPORT,
			defaultValue = PropertyConstants.BOOLEAN_FALSE,
			scopes = {PropertyScope.ELEMENT},
	...
	@Property(
			name = "com.github.exerrk.export.json.number.{path}",
			category = PropertyConstants.CATEGORY_EXPORT,
			scopes = {PropertyScope.ELEMENT},
			sinceVersion = PropertyConstants.VERSION_6_1_0
			)
	...
	@Property(
			name = "com.github.exerrk.export.json.date.{path}",
			category = PropertyConstants.CATEGORY_EXPORT,
			scopes = {PropertyScope.ELEMENT},
			sinceVersion = PropertyConstants.VERSION_6_1_0
			)
	...
	@Property(
			name = "com.github.exerrk.export.json.boolean.{path}",
			category = PropertyConstants.CATEGORY_EXPORT,
			scopes = {PropertyScope.ELEMENT},
			sinceVersion = PropertyConstants.VERSION_6_1_0
			)
	...
	@Property(
			name = "com.github.exerrk.export.json.string.{path}",
			category = PropertyConstants.CATEGORY_EXPORT,
			scopes = {PropertyScope.ELEMENT},
			sinceVersion = PropertyConstants.VERSION_6_1_0
			)
