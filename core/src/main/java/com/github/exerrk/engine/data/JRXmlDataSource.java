...
import com.github.exerrk.engine.util.JRXmlUtils;
import com.github.exerrk.engine.util.xml.JRXPathExecuter;
import com.github.exerrk.engine.util.xml.JRXPathExecuterUtils;
 ...
 * custom property at field level. The use of the {@link com.github.exerrk.engine.JRField#getDescription() field description} to specify the XPath expression
 ...
 * <ul>
 * <li>"((com.github.exerrk.engine.data.JRXmlDataSource)$P{REPORT_DATA_SOURCE}).subDataSource("/B/C")
 * 	- in the context of the node B, creates a data source with elements of type /B/C
 * <li>"((com.github.exerrk.engine.data.JRXmlDataSource)$P{REPORT_DATA_SOURCE}).dataSource("/A/D")
...
public class JRXmlDataSource extends AbstractXmlDataSource<JRXmlDataSource>
{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.github.exerrk.engine.JRRewindableDataSource#moveFirst()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.github.exerrk.engine.JRDataSource#next()
	 */
	@Override
	public boolean next() 
	{
