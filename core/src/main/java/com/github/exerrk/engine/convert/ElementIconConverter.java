...
public class ElementIconConverter extends ElementConverter
{
	 ...
	 */
	protected com.github.exerrk.engine.Renderable getRenderer(JasperReportsContext jasperReportsContext)
	{
		try
		{
			return 
				com.github.exerrk.engine.RenderableUtil.getInstance(jasperReportsContext).getRenderable(
					iconLocation, 
