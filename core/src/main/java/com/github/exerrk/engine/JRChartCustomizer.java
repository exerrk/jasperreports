 ...
 * should extend {@link com.github.exerrk.engine.JRAbstractChartCustomizer JRAbstractChartCustomizer}
...
{
	@Property(
			name = "com.github.exerrk.customizer.{arbitrary_name}.{property_name}",
	...
	@Property(
			name = "com.github.exerrk.customizer.class.{arbitrary_name}",
			category = PropertyConstants.CATEGORY_FILL,
