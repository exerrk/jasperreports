...
import com.github.exerrk.engine.virtualization.VirtualizationInput;
import com.github.exerrk.engine.virtualization.VirtualizationOutput;
import com.github.exerrk.renderers.Renderable;
import com.github.exerrk.renderers.ResourceRenderer;


/**
 * Implementation of {@link com.github.exerrk.engine.JRPrintImage} that uses
 * a {@link com.github.exerrk.engine.fill.JRTemplateImage} instance to
...
public class JRTemplatePrintImage extends JRTemplatePrintGraphicElement implements JRPrintImage
{
	 ...
	 */
	@Override
	public com.github.exerrk.engine.Renderable getRenderable()
	{
		return com.github.exerrk.engine.RenderableUtil.getWrappingRenderable(renderable);
	}
	 ...
	 */
	@Override
	public void setRenderable(com.github.exerrk.engine.Renderable renderable)
	{
	 ...
	 * @deprecated
	 */
	private com.github.exerrk.engine.JRRenderable renderer;
	...
	private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException
	{
		...
		if (renderer != null && renderable == null)
		{
			...
			{
				renderable = com.github.exerrk.engine.RenderableUtil.getWrappingRenderable(renderer);
			}
		}
	}
