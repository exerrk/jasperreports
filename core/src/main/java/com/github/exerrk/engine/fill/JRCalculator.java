 ...
 * template ({@link com.github.exerrk.engine.JasperReport} object) information that it
 * will use at report-filling time to build an instance of the 
 * {@link com.github.exerrk.engine.fill.JRCalculator} class.
 * </p><p>
 * The Java-based report compilers generate a Java source file and compile it on the fly.
 * This generated class is a subclass of the {@link com.github.exerrk.engine.fill.JRCalculator},
 * and the bytecode produced by compiling it is stored inside the 
 * {@link com.github.exerrk.engine.JasperReport} object. At report-filling time, this
