 ...
 * <p/>
 * <code>&lt;property name="com.github.exerrk.export.pdf.tag.h1" value="full"/&gt;</code>
 * <p/>
 ...
 * <br/>
 * <code>&lt;property name="com.github.exerrk.export.pdf.tag.h1" value="full"/&gt;</code></li>
 ...
 * <br/>
 * <code>&lt;property name="com.github.exerrk.export.pdf.tag.h1" value="start"/&gt;</code>
 * <br/>
 * and the last element from the heading (respective to the same order) is marked with
 * <br/>
 * <code>&lt;property name="com.github.exerrk.export.pdf.tag.h1" value="end"/&gt;</code></li>
 * </ul>
 * <p/>
 * Level 2 and level 3 headings are marked the same way, except that the properties are:
 * <p/>
 * <code>com.github.exerrk.export.pdf.tag.h2</code>
 * <p/>
 * and
 * <p/>
 * <code>com.github.exerrk.export.pdf.tag.h3</code>.
 ...
 * <p/>
 * <code>&lt;property name="com.github.exerrk.export.pdf.tag.table" value="full"/&gt;</code>
 * <p/>
 ...
 * <p/>
 * <code>&lt;property name="com.github.exerrk.export.pdf.tag.table" value="start"/&gt;</code>
 * <p/>
 * The last element of the table should be marked with:
 * <p/>
 * <code>&lt;property name="com.github.exerrk.export.pdf.tag.table" value="end"/&gt;</code>
 * <p/>
 ...
 * marked with the following custom property:
 * <br/>
 * <code>&lt;property name="com.github.exerrk.export.pdf.tag.tr" value="full"/&gt;</code>
 * </li>
 ...
 * <br/>
 * <code>&lt;property name="com.github.exerrk.export.pdf.tag.tr" value="start"/&gt;</code>
 * <br/>
 ...
 * marked with
 * <p/>
 * <code>&lt;property name="com.github.exerrk.export.pdf.tag.th" value="full"/&gt;</code>
 * <p/>
 * A header cell made of multiple elements is marked with
 * <p/>
 * <code>&lt;property name="com.github.exerrk.export.pdf.tag.th" value="start"/&gt;</code>
 * on its first element and
 * <p/>
 * <code>&lt;property name="com.github.exerrk.export.pdf.tag.th" value="end"/&gt;</code>
 * on its last element.
 * <p/>
 * Normal data cells made of a single element (that can be frame) are marked with
 * <p/>
 * <code>&lt;property name="com.github.exerrk.export.pdf.tag.td" value="full"/&gt;</code>
 * <p/>
 * Normal data cells made of multiple elements are marked with
 * <p/>
 * <code>&lt;property name="com.github.exerrk.export.pdf.tag.td" value="start"/&gt;</code>
 * on their first element and
 * <p/>
 * <code>&lt;property name="com.github.exerrk.export.pdf.tag.td" value="end"/&gt;</code>
 ...
 * <p/>
 * <code>&lt;property name="com.github.exerrk.export.pdf.tag.colspan" value="&lt;number&gt;"/&gt;</code>
 * <p/>
 * <code>&lt;property name="com.github.exerrk.export.pdf.tag.rowspan" value="&lt;number&gt;"/&gt;</code>
