...
public interface JRParameter extends JRPropertiesHolder, JRCloneable
{
	...
	/**
	 * A <tt>com.github.exerrk.engine.JasperReportsContext</tt> instance representing the current report filling context.
	 */
	public static final String JASPER_REPORTS_CONTEXT = "JASPER_REPORTS_CONTEXT";


	/**
	 * This parameter gives access to the current {@link com.github.exerrk.engine.JasperReport}
	 ...
	 * {@link com.github.exerrk.engine.JRDataSource} instance.
	 * </p><p>
	...
	/**
	 * A {@link com.github.exerrk.engine.JRDataSource} instance representing the report data source.
	 * JasperReports defines some convenience implementations
	 * of {@link com.github.exerrk.engine.JRDataSource}, but users may create their own data sources for specific needs.
	 * <p>
	 ...
	 * {@link com.github.exerrk.engine.JRAbstractScriptlet} instance, which in this case
	 * is a {@link com.github.exerrk.engine.JRDefaultScriptlet} object. When using
	...
	/**
	 * The {@link com.github.exerrk.engine.JRVirtualizer} to be used for page virtualization.  This parameter is optional.
	 * <p>
	 ...
	 * {@link com.github.exerrk.engine.JRVirtualizer} interface as the value for this
	...
	/**
	 * A {@link com.github.exerrk.engine.util.FormatFactory} instance to be used
	 ...
	 * {@link com.github.exerrk.engine.util.FormatFactory} interface, which is either
