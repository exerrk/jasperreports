 ...
 * {@link com.github.exerrk.export.ReportExportConfiguration#getExporterFilter()} exporter
 ...
 * <pre>
 *   &lt;property name="com.github.exerrk.export.xls.exclude.origin.band.1" value="pageHeader"/&gt;
 *   &lt;property name="com.github.exerrk.export.xls.exclude.origin.band.2" value="pageFooter"/&gt;
 * </pre>
 ...
 * <pre>
 *   &lt;property name="com.github.exerrk.export.xls.exclude.origin.keep.first.band.1" value="pageHeader"/&gt;
 *   &lt;property name="com.github.exerrk.export.xls.exclude.origin.band.2" value="pageFooter"/&gt;
 * </pre>
 ...
 *   &lt;property name="com.github.exerrk.export.xls.exclude.origin.band.1" value="pageHeader"/&gt;
 *   &lt;property name="com.github.exerrk.export.xls.exclude.origin.band.2" value="pageFooter"/&gt;
 *   &lt;property name="com.github.exerrk.export.xls.exclude.origin.band.3" value="groupHeader"/&gt;
 *   &lt;property name="com.github.exerrk.export.xls.exclude.origin.group.3" value="ProductGroup"/&gt;
 *   &lt;property name="com.github.exerrk.export.xls.exclude.origin.report.3" value="ProductReport"/&gt;
 * </pre>
 ...
 * <pre>
 *   &lt;property name="com.github.exerrk.export.xls.exclude.origin.keep.first.band.myGroupFilter" value="groupHeader"/&gt;
 *   &lt;property name="com.github.exerrk.export.xls.exclude.origin.keep.first.group.myGroupFilter" value="ProductGroup"/&gt;
 *   &lt;property name="com.github.exerrk.export.xls.exclude.origin.keep.first.report.myGroupFilter" value="ProductReport"/&gt;
 * </pre>
 ...
 * <pre>
 *   com.github.exerrk.export.{format}.exclude.origin.{suffix}.{arbitrary_name}
 *   com.github.exerrk.export.{format}.exclude.origin.keep.first.{suffix}.{arbitrary_name}
 * </pre>
...
public class JROriginExporterFilter implements ResetableExporterFilter
{
	 ...
	 */
	@Property(
			name = "com.github.exerrk.export.{format}.exclude.origin.{suffix}.{arbitrary_name}",
	...
	@Property(
			name = "com.github.exerrk.export.{format}.exclude.origin.keep.first.{suffix}.{arbitrary_name}",
			category = PropertyConstants.CATEGORY_EXPORT,
			scopes = {PropertyScope.CONTEXT, PropertyScope.REPORT},
			sinceVersion = PropertyConstants.VERSION_2_0_3
			)
