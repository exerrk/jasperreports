 ...
 * <ul>
 * <li>{@link com.github.exerrk.engine.JRAbstractScriptlet}</li>
 * <li>{@link com.github.exerrk.engine.JRDefaultScriptlet}</li>
 * </ul>
 * Any number of scriptlets can be specified per report. If no scriplet is specified for a 
 * report, the engine still creates a single {@link com.github.exerrk.engine.JRDefaultScriptlet}
 * instance and registers it with the built-in {@link com.github.exerrk.engine.JRParameter#REPORT_SCRIPTLET REPORT_SCRIPTLET}
 * parameter. 
 * <p>
 * For each scriplet, a name and a class extending the 
 * {@link com.github.exerrk.engine.JRAbstractScriptlet} class must
 ...
 * should implement or override, including {@link com.github.exerrk.engine.JRAbstractScriptlet#beforeReportInit() beforeReportInit()},
 * {@link com.github.exerrk.engine.JRAbstractScriptlet#afterReportInit() afterReportInit()},
 * {@link com.github.exerrk.engine.JRAbstractScriptlet#beforePageInit() beforePageInit()},
 * {@link com.github.exerrk.engine.JRAbstractScriptlet#afterPageInit() afterPageInit()},
 * {@link com.github.exerrk.engine.JRAbstractScriptlet#beforeGroupInit(String)}, and
 * {@link com.github.exerrk.engine.JRAbstractScriptlet#afterGroupInit(String)}. The report engine calls these methods at the appropriate time when
 * filling the report. 
 * </p><p> 
 ...
 * {@link com.github.exerrk.engine.scriptlets.ScriptletFactory} interface.
 * </p><p>
 ...
 * interval. 
 * </p><p>
 * The {@link com.github.exerrk.governors.MaxPagesGovernor} is a global scriptlet
 * that is looking for two configuration properties to decide if it applies or not to the report 
 * currently being run:</p>
 * <pre> 
 *   com.github.exerrk.governor.max.pages.enabled=[true|false]
 *   com.github.exerrk.governor.max.pages=[integer]</pre>
 * The {@link com.github.exerrk.governors.TimeoutGovernor} is also a global scriptlet
 * that is looking for the following two configuration properties to decide if it applies or 
 * not: 
 * <pre>
 *   com.github.exerrk.governor.timeout.enabled=[true|false]
 *   com.github.exerrk.governor.timeout=[milliseconds]</pre>
 ...
 * 
 * @see com.github.exerrk.engine.JRAbstractScriptlet
 * @see com.github.exerrk.engine.JRDefaultScriptlet
 * @see com.github.exerrk.engine.JRParameter#REPORT_SCRIPTLET
 * @see com.github.exerrk.governors.MaxPagesGovernor
 * @see com.github.exerrk.governors.TimeoutGovernor
 */
