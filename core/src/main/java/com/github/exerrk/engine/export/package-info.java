 ...
 * {@link com.github.exerrk.engine.JasperExportManager JasperExportManager}; it can be used to obtain
 * PDF, HTML, or XML content for the documents produced by the report-filling process. 
 * Exporting means taking a {@link com.github.exerrk.engine.JasperPrint JasperPrint} object,
 ...
 * </p><p>
 * The {@link com.github.exerrk.engine.JasperExportManager JasperExportManager} class offers
 ...
 * simple interface called {@link com.github.exerrk.export.Exporter}. Every
 ...
 * {@link com.github.exerrk.export.Exporter} interface, and this method does not
 * receive any parameters when called. 
 * <p>
 * The input data for an exporter comes in the form of one or more 
 * {@link com.github.exerrk.engine.JasperPrint}
 ...
 * extend the {@link com.github.exerrk.engine.JRAbstractExporter} class, which
 ...
 * all we need is an {@link com.github.exerrk.export.ExporterInput} instance that holds the necessary
 * input data. This object must implement the <code>public List&lt;ExporterInputItem&gt; getItems()</code> 
 * method in order to obtain a list of {@link com.github.exerrk.export.ExporterInputItem} objects. Each
 * {@link com.github.exerrk.export.ExporterInputItem} object in the list contains a single
 * {@link com.github.exerrk.engine.JasperPrint} object along with its related export
 ...
 * {@link com.github.exerrk.export.ExporterOutput} setting to see whether it needs to
 ...
 * {@link com.github.exerrk.engine.JRAbstractExporter} parent class. The <code>exporterOutput</code>
 * argument must be an instance of {@link com.github.exerrk.export.ExporterOutput} interface.
 * </p>
 ...
 * {@link com.github.exerrk.engine.JRAbstractExporter} parent class. The first method accepts
 * an {@link com.github.exerrk.export.ExporterConfiguration} argument and applies settings per exporter.
 * The second one accepts a {@link com.github.exerrk.export.ReportExportConfiguration} and applies
 ...
 * {@link com.github.exerrk.export.ReportExportConfiguration} class:
 * <ul>
 ...
 * {@link com.github.exerrk.engine.JasperPrint} document or a list with several such generated documents. Exporting
 * multiple {@link com.github.exerrk.engine.JasperPrint} objects to a single resulting document is called batch mode
 * exporting. 
 * <p>
 * Not all exporters can work in batch mode, but those that do first look into the supplied 
 * exporter input values to see whether a <code>java.util.List</code> of {@link com.github.exerrk.engine.JasperPrint}
 ...
 * </p><p>
 * If the exporters act on a single document, then they check whether an in-memory {@link com.github.exerrk.engine.JasperPrint}
 * value is supplied to the exporter input data. If no such value is found for this setting, then the input for the 
 * exporter is a single {@link com.github.exerrk.engine.JasperPrint} document to be loaded from an input stream, an URL,
 ...
 * {@link com.github.exerrk.export.ReportExportConfiguration}
 * class) should be used to pass a filter object, which would be an instance of a class that 
 * implements the {@link com.github.exerrk.engine.export.ExporterFilter}
 ...
 * {@link com.github.exerrk.engine.JRAbstractExporter#PROPERTY_DEFAULT_FILTER_FACTORY com.github.exerrk.engine.export.default.filter.factory}.
 * </p><p>
 ...
 * so, a property named {@link com.github.exerrk.engine.export.DefaultExporterFilterFactory#PROPERTY_EXPORTER_FILTER_FACTORY_PREFIX com.github.exerrk.engine.export.filter.factory.&lt;factory_name&gt;} has
 * to be included in the <code>jasperreports.properties</code> file (or set at runtime via 
 * {@link com.github.exerrk.engine.JRPropertiesUtil JRPropertiesUtil}). The factory name is an arbitrary suffix, and the property value should
 * be the name of a class that implements 
 * {@link com.github.exerrk.engine.export.ExporterFilterFactory ExporterFilterFactory}. The engine
 ...
 * {@link com.github.exerrk.engine.export.ExporterFilter}. This filter will be
 ...
 * <code>com.github.exerrk.export.&lt;output_format&gt;</code>. Below are the
 * property prefixes for the built-in output formats: 
 * <ul>
 * <li><code>Java Print/Graphics2D</code> - <code>com.github.exerrk.export.graphics2d</code></li>
 * <li><code>PDF</code> - <code>com.github.exerrk.export.pdf</code></li>
 * <li><code>RTF</code> - <code>com.github.exerrk.export.rtf</code></li>
 * <li><code>XML</code> - <code>com.github.exerrk.export.xml</code></li>
 * <li><code>HTML</code> - <code>com.github.exerrk.export.html</code></li>
 * <li><code>Excel</code> - <code>com.github.exerrk.export.xls</code></li>
 * <li><code>DOCX</code> - <code>com.github.exerrk.export.docx</code></li>
 * <li><code>PPTX</code> - <code>com.github.exerrk.export.pptx</code></li>
 * <li><code>ODT</code> - <code>com.github.exerrk.export.odt</code></li>
 * <li><code>ODS</code> - <code>com.github.exerrk.export.ods</code></li>
 * <li><code>CSV</code> - <code>com.github.exerrk.export.csv</code></li>
 * <li><code>Text</code> - <code>com.github.exerrk.export.txt</code></li>
 * </ul>
 ...
 * called {@link com.github.exerrk.engine.export.JRExportProgressMonitor}. To
 ...
 * {@link com.github.exerrk.engine.JasperPrint} object.
 * </p>
 ...
 * 
 * @see com.github.exerrk.engine.JasperExportManager
 * @see com.github.exerrk.engine.JasperPrint
 * @see com.github.exerrk.engine.JRAbstractExporter
 * @see com.github.exerrk.export.Exporter
 * @see com.github.exerrk.export.ExporterConfiguration
 * @see com.github.exerrk.export.ExporterInput
 * @see com.github.exerrk.export.ExporterInputItem
 * @see com.github.exerrk.export.ExporterOutput
 * @see com.github.exerrk.export.ReportExportConfiguration
 */
