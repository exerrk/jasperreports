...
import com.github.exerrk.engine.JRAbstractExporter;
...
import com.github.exerrk.engine.JRPrintAnchor;
...
import com.github.exerrk.engine.fonts.AwtFontAttribute;
import com.github.exerrk.engine.fonts.FontFace;
import com.github.exerrk.engine.fonts.FontFamily;
import com.github.exerrk.engine.fonts.FontInfo;
...
import com.github.exerrk.engine.util.BreakIteratorSplitCharacter;
import com.github.exerrk.engine.util.ImageUtil;
import com.github.exerrk.engine.util.JRImageLoader;
import com.github.exerrk.engine.util.JRLoader;
import com.github.exerrk.engine.util.JRPdfaIccProfileNotFoundException;
import com.github.exerrk.engine.util.JRStyledText;
import com.github.exerrk.engine.util.JRTextAttribute;
import com.github.exerrk.engine.util.NullOutputStream;
import com.github.exerrk.export.ExportInterruptedException;
import com.github.exerrk.export.ExporterInputItem;
import com.github.exerrk.export.OutputStreamExporterOutput;
import com.github.exerrk.export.PdfExporterConfiguration;
import com.github.exerrk.export.PdfReportConfiguration;
import com.github.exerrk.export.type.PdfPermissionsEnum;
import com.github.exerrk.export.type.PdfPrintScalingEnum;
import com.github.exerrk.export.type.PdfVersionEnum;
import com.github.exerrk.export.type.PdfaConformanceEnum;
import com.github.exerrk.properties.PropertyConstants;
import com.github.exerrk.renderers.DataRenderable;
...
import com.github.exerrk.renderers.WrappingImageDataToGraphics2DRenderer;
import com.github.exerrk.renderers.WrappingSvgDataToGraphics2DRenderer;
 ...
 * {@link com.github.exerrk.engine.export.JRPdfExporter} class in JasperReports is
 * one of the best exporters. The output it produces is almost of the same quality as that
 * produced by the {@link com.github.exerrk.engine.export.JRGraphics2DExporter},
 * which is always the reference.
 * <p/>
 * The {@link com.github.exerrk.engine.export.JRPdfExporter} implementation uses iText,
 ...
 * {@link com.github.exerrk.engine.export.JRPdfExporter} internally acquires the needed PDF
 ...
 * {@link com.github.exerrk.export.PdfExporterConfiguration#isCreatingBatchModeBookmarks() isCreatingBatchModeBookmarks()}
 ...
 * There are five exporter configuration settings for this (see {@link com.github.exerrk.export.PdfExporterConfiguration}):
 * <ul>
 * <li>{@link com.github.exerrk.export.PdfExporterConfiguration#isEncrypted() isEncrypted()}</li>
 * <li>{@link com.github.exerrk.export.PdfExporterConfiguration#is128BitKey() is128BitKey()}</li>
 * <li>{@link com.github.exerrk.export.PdfExporterConfiguration#getUserPassword() getUserPassword()}</li>
 * <li>{@link com.github.exerrk.export.PdfExporterConfiguration#getOwnerPassword() getOwnerPassword()}</li>
 * <li>{@link com.github.exerrk.export.PdfExporterConfiguration#getPermissions() getPermissions()}</li>
 * </ul>
 ...
 * (see {@link com.github.exerrk.export.PdfExporterConfiguration}):
 * <ul>
 * <li>{@link com.github.exerrk.export.PdfExporterConfiguration#getPdfVersion() getPdfVersion()}</li>
 * <li>{@link com.github.exerrk.export.PdfExporterConfiguration#isCompressed() isCompressed()}</li>
 * </ul>
 ...
 * on using the {@link com.github.exerrk.export.PdfExporterConfiguration#isCompressed() isCompressed()}
 ...
 * {@link com.github.exerrk.export.PdfReportConfiguration#isForceLineBreakPolicy() isForceLineBreakPolicy()}
 ...
 * {@link com.github.exerrk.export.PdfReportConfiguration#PROPERTY_FORCE_LINEBREAK_POLICY com.github.exerrk.export.pdf.force.linebreak.policy} configuration
 * property
 ...
 * {@link com.github.exerrk.export.PdfExporterConfiguration#getPdfJavaScript() getPdfJavaScript()}
 ...
 * configuration settings available in the {@link com.github.exerrk.export.PdfExporterConfiguration}
 * class. They are all listed following:
 * <ul>
 * <li>{@link com.github.exerrk.export.PdfExporterConfiguration#getMetadataAuthor() getMetadataAuthor()}</li>
 * <li>{@link com.github.exerrk.export.PdfExporterConfiguration#getMetadataCreator() getMetadataCreator()}</li>
 * <li>{@link com.github.exerrk.export.PdfExporterConfiguration#getMetadataKeywords() getMetadataKeywords()}</li>
 * <li>{@link com.github.exerrk.export.PdfExporterConfiguration#getMetadataSubject() getMetadataSubject()}</li>
 * <li>{@link com.github.exerrk.export.PdfExporterConfiguration#getMetadataTitle() getMetadataTitle()}</li>
 * </ul>
 * <h3>Rendering SVG Using Shapes</h3>
 * The {@link com.github.exerrk.export.PdfReportConfiguration#isForceSvgShapes() isForceSvgShapes()}
 ...
 * {@link com.github.exerrk.renderers.Renderable} implementations,
 * which are most likely subclasses of the {@link com.github.exerrk.renderers.AbstractRenderToImageDataRenderer}
 ...
 * <ul>
 * <li>{@link com.github.exerrk.engine.util.JRTextAttribute#PDF_FONT_NAME PDF_FONT_NAME}</li>
 * <li>{@link com.github.exerrk.engine.util.JRTextAttribute#PDF_ENCODING PDF_ENCODING}</li>
 * <li>{@link com.github.exerrk.engine.util.JRTextAttribute#IS_PDF_EMBEDDED IS_PDF_EMBEDDED}</li>
 * </ul>
 * <p/>
 ...
 * {@link com.github.exerrk.export.PdfReportConfiguration#PROPERTY_FORCE_SVG_SHAPES com.github.exerrk.export.pdf.force.svg.shapes} configuration property.
 * The {@link com.github.exerrk.export.PdfReportConfiguration#isForceSvgShapes() isForceSvgShapes()}
 ...
 * <ul>
 * <li>setting to true the {@link com.github.exerrk.export.PdfExporterConfiguration#isTagged() isTagged()}
 * configuration flag</li>
 * <li>setting to true the {@link com.github.exerrk.export.PdfExporterConfiguration#PROPERTY_TAGGED com.github.exerrk.export.pdf.tagged} configuration property.</li>
 * </ul>
 ...
 * <ul>
 * <li>using the {@link com.github.exerrk.export.PdfExporterConfiguration#getTagLanguage() getTagLanguage()}
 * configuration setting to retrieve the language as a <code>java.lang.String</code> value;</li>
 * <li>using the {@link com.github.exerrk.export.PdfExporterConfiguration#PROPERTY_TAG_LANGUAGE com.github.exerrk.export.pdf.tag.language} configuration property
 ...
 * please consult the {@link com.github.exerrk.engine.export.JRPdfExporterTagHelper} class.
 * 
 * @see com.github.exerrk.export.PdfExporterConfiguration
 * @see com.github.exerrk.export.PdfReportConfiguration
 * @see com.github.exerrk.engine.util.JRTextAttribute#IS_PDF_EMBEDDED
 * @see com.github.exerrk.engine.util.JRTextAttribute#PDF_ENCODING
 * @see com.github.exerrk.engine.util.JRTextAttribute#PDF_FONT_NAME
...
public class JRPdfExporter extends JRAbstractExporter<PdfReportConfiguration, PdfExporterConfiguration, OutputStreamExporterOutput, JRPdfExporterContext>
{
	 ...
	 */
	@Property(
			name = "com.github.exerrk.export.pdf.font.{arbitrary_name}",
	 ...
	 */
	@Property(
			name = "com.github.exerrk.export.pdf.fontdir.{arbitrary_name}",
			category = PropertyConstants.CATEGORY_EXPORT,
			scopes = {PropertyScope.GLOBAL},
			sinceVersion = PropertyConstants.VERSION_1_0_0
			)
	...
	protected void ensureOutput()
	{
		...
		{
			exporterOutput = 
				new com.github.exerrk.export.parameters.ParametersOutputStreamExporterOutput(
	...
	protected void exportReportToStream(OutputStream os) throws JRException
	{
		...
		try
		{
			...
			if( creator == null )
			{
				creator = "JasperReports Library version " + Package.getPackage("com.github.exerrk.engine").getImplementationVersion();
			}
