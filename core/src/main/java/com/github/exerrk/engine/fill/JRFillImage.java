		...
		) throws JRException
	{
		...
		if (source != null)
		{
			...
			else
			{
				...
				com.github.exerrk.engine.JRRenderable deprecatedRenderable =
					source instanceof com.github.exerrk.engine.JRRenderable
					? (com.github.exerrk.engine.JRRenderable)source
					: null;
				...
				else if (deprecatedRenderable != null)
				{
					...
					Renderable wrappingRenderable = 
						com.github.exerrk.engine.RenderableUtil.getWrappingRenderable(deprecatedRenderable);
