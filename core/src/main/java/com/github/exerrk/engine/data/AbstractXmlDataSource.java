...
import com.github.exerrk.engine.query.JRXPathQueryExecuterFactory;
...
public abstract class AbstractXmlDataSource<T extends AbstractXmlDataSource<?>> extends JRAbstractTextDataSource implements JRRewindableDataSource 
{
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.github.exerrk.engine.JRDataSource#getFieldValue(com.github.exerrk.engine.JRField)
	 */
	@Override
