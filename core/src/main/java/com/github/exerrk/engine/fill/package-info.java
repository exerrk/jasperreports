 ...
 * <li>data source</li>
 * </ul>
 * The output is always a single, final {@link com.github.exerrk.engine.JasperPrint}
 * document ready to be viewed, printed, or exported to other formats. 
 * </p><p>
 * The {@link com.github.exerrk.engine.JasperFillManager} class is usually used for
 ...
 * {@link com.github.exerrk.engine.JasperReport} objects. After getting the report template,
 * the report filling methods are calling the related <code>fill(...)</code> method in the 
 * {@link com.github.exerrk.engine.fill.JRFiller} class, that actually fills the report.
 * </p><p>
 ...
 * {@link com.github.exerrk.engine.util.JRLoader} utility class. This way, one can
 ...
 * {@link com.github.exerrk.engine.JasperPrint} objects, which are serializable. This
 * allows the parent application to store them or transfer them over the network if needed. 
 * <p>
 * At the top level, a {@link com.github.exerrk.engine.JasperPrint} object contains some document-specific information,
 ...
 * ({@link com.github.exerrk.engine.JRPrintPage} instances), each page having a
 ...
 * {@link com.github.exerrk.engine.fill.JRVerticalFiller} class.</li>
 * <li><code>Horizontal</code> - meaning that they first run from left to right and then from top to bottom. In this case 
 * the report is filled using methods in the {@link com.github.exerrk.engine.fill.JRHorizontalFiller} class.</li>
 * </ul>
 ...
 * {@link com.github.exerrk.engine.fill.AsynchronousFillHandle} class to be used
 ...
 * {@link com.github.exerrk.engine.fill.AsynchronousFilllListener} interface. The
 ...
 * <ul>
 * <li>The handle is created by calling the static <code>createHandle()</code> methods in {@link com.github.exerrk.engine.fill.AsynchronousFillHandle AsynchronousFillHandle}
 ...
 * {@link com.github.exerrk.engine.JasperPrint} object could also be very large and might cause
 ...
 * ({@link com.github.exerrk.engine.JRVirtualizer}) that enables the reporting engine
 ...
 * {@link com.github.exerrk.engine.JRVirtualizer} interface as the value for the built-in
 * {@link com.github.exerrk.engine.JRParameter#REPORT_VIRTUALIZER REPORT_VIRTUALIZER}
 * parameter when filling the report.
 * </p><p>
 * In virtualized form, a generated {@link com.github.exerrk.engine.JasperPrint} document still behaves normally and can
 ...
 * into temporary files), once completed, a {@link com.github.exerrk.engine.JasperPrint} document can itself be serialized
 * normally without any loss of information. During the serialization of a virtualized 
 * {@link com.github.exerrk.engine.JasperPrint} object, the program puts back together all the pieces and a single
 ...
 * {@link com.github.exerrk.engine.fill.JRFileVirtualizer}, which stores document
 * pages on disk during the filling process to free up memory. Once a {@link com.github.exerrk.engine.JasperPrint} object
 ...
 * A single {@link com.github.exerrk.engine.fill.JRFileVirtualizer} instance can be shared across multiple report-filling
 ...
 * {@link com.github.exerrk.engine.fill.JRFileVirtualizer#PROPERTY_TEMP_FILES_SET_DELETE_ON_EXIT com.github.exerrk.virtualizer.files.delete.on.exit} configuration property.
 * </p>
 ...
 * pose additional problems. This makes the use of the {@link com.github.exerrk.engine.fill.JRFileVirtualizer}
 ...
 * {@link com.github.exerrk.engine.fill.JRSwapFileVirtualizer} class that is
 * part of the JasperReports library core functionality, and works in combination with a 
 * {@link com.github.exerrk.engine.util.JRSwapFile} instance representing the target
 * swap file. 
 * </p><p>
 * The {@link com.github.exerrk.engine.util.JRSwapFile} instance has to be created and configured prior to being passed to the
 ...
 * </p><p>
 * The {@link com.github.exerrk.engine.util.JRConcurrentSwapFile} class
 ...
 * The {@link com.github.exerrk.engine.fill.JRGzipVirtualizer} is a convenient
 ...
 * 
 * @see com.github.exerrk.engine.JasperFillManager
 * @see com.github.exerrk.engine.JasperPrint
 * @see com.github.exerrk.engine.JasperReport
 * @see com.github.exerrk.engine.JRPrintPage
 * @see com.github.exerrk.engine.JRVirtualizer
 * @see com.github.exerrk.engine.util.JRConcurrentSwapFile
 * @see com.github.exerrk.engine.util.JRLoader
 * @see com.github.exerrk.engine.util.JRSwapFile
 */
