...
import com.github.exerrk.engine.base.JRBaseQuery;
...
import com.github.exerrk.engine.util.JRQueryChunkHandler;
...
public class JRDesignQuery extends JRBaseQuery implements JRChangeEventsSupport
{
	 ...
	 * @see com.github.exerrk.engine.JRQuery#getLanguage()
	 */
