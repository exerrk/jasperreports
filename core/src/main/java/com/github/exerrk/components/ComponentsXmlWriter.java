...
import com.github.exerrk.components.barbecue.BarbecueComponent;
import com.github.exerrk.components.barcode4j.BarcodeComponent;
import com.github.exerrk.components.barcode4j.BarcodeXmlWriter;
...
import com.github.exerrk.components.list.ListContents;
import com.github.exerrk.components.map.MapComponent;
import com.github.exerrk.components.map.MapXmlFactory;
import com.github.exerrk.components.map.type.MapImageTypeEnum;
import com.github.exerrk.components.map.type.MapScaleEnum;
import com.github.exerrk.components.map.type.MapTypeEnum;
import com.github.exerrk.components.sort.SortComponent;
import com.github.exerrk.components.sort.SortComponentXmlWriter;
import com.github.exerrk.components.spiderchart.SpiderChartComponent;
import com.github.exerrk.components.spiderchart.SpiderChartXmlWriter;
...
import com.github.exerrk.components.table.GroupCell;
...
public class ComponentsXmlWriter extends AbstractComponentXmlWriter
{
	...
	protected void writeMap(JRComponentElement componentElement, JRXmlWriter reportWriter) throws IOException
	{
		...
		if(isNewerVersionOrEqual(componentElement, reportWriter, JRConstants.VERSION_5_5_2)) {
			...
			@SuppressWarnings("deprecation")
			com.github.exerrk.components.map.MarkerDataset dataset = map.getMarkerDataset();
	 ...
	 */
	private void writeMarkerDataset(com.github.exerrk.components.map.MarkerDataset dataset, JRXmlWriteHelper writer, JRXmlWriter reportWriter, XmlNamespace namespace, JRComponentElement componentElement) throws IOException
	{
		if (dataset != null)
		{
			...
			/*   */
			List<com.github.exerrk.components.map.Marker> markerList = dataset.getMarkers();
			if (markerList != null && !markerList.isEmpty())
			{
				for(com.github.exerrk.components.map.Marker marker : markerList)
				{
	...
	private void writeMarker(
		com.github.exerrk.components.map.Marker marker,
		...
		) throws IOException
	{
		...
		List<com.github.exerrk.components.map.MarkerProperty> markerProperties = marker.getProperties();
		for(com.github.exerrk.components.map.MarkerProperty property : markerProperties)
		{
	...
	private void writeMarkerProperty(
		com.github.exerrk.components.map.MarkerProperty markerProperty,
		JRXmlWriteHelper writer, 
		JRXmlWriter reportWriter, 
		XmlNamespace namespace, 
		JRComponentElement componentElement
