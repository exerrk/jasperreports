...
import com.github.exerrk.components.barbecue.StandardBarbecueComponent;
import com.github.exerrk.components.barcode4j.CodabarComponent;
import com.github.exerrk.components.barcode4j.Code128Component;
import com.github.exerrk.components.barcode4j.Code39Component;
import com.github.exerrk.components.barcode4j.DataMatrixComponent;
import com.github.exerrk.components.barcode4j.EAN128Component;
import com.github.exerrk.components.barcode4j.EAN13Component;
import com.github.exerrk.components.barcode4j.EAN8Component;
import com.github.exerrk.components.barcode4j.ErrorCorrectionLevelEnum;
import com.github.exerrk.components.barcode4j.Interleaved2Of5Component;
import com.github.exerrk.components.barcode4j.OrientationEnum;
import com.github.exerrk.components.barcode4j.OrientationRule;
import com.github.exerrk.components.barcode4j.PDF417Component;
import com.github.exerrk.components.barcode4j.POSTNETComponent;
import com.github.exerrk.components.barcode4j.QRCodeComponent;
import com.github.exerrk.components.barcode4j.RoyalMailCustomerComponent;
import com.github.exerrk.components.barcode4j.TextPositionEnum;
import com.github.exerrk.components.barcode4j.UPCAComponent;
import com.github.exerrk.components.barcode4j.UPCEComponent;
import com.github.exerrk.components.barcode4j.USPSIntelligentMailComponent;
import com.github.exerrk.components.iconlabel.IconLabelComponentDigester;
import com.github.exerrk.components.items.Item;
import com.github.exerrk.components.items.ItemData;
import com.github.exerrk.components.items.ItemDataXmlFactory;
import com.github.exerrk.components.items.ItemDatasetFactory;
import com.github.exerrk.components.items.ItemProperty;
import com.github.exerrk.components.items.ItemPropertyXmlFactory;
import com.github.exerrk.components.items.ItemXmlFactory;
import com.github.exerrk.components.list.DesignListContents;
import com.github.exerrk.components.list.StandardListComponent;
import com.github.exerrk.components.map.MapXmlFactory;
import com.github.exerrk.components.sort.SortComponentDigester;
import com.github.exerrk.components.spiderchart.SpiderChartDigester;
import com.github.exerrk.components.table.DesignCell;
import com.github.exerrk.components.table.StandardColumn;
import com.github.exerrk.components.table.StandardColumnGroup;
import com.github.exerrk.components.table.StandardGroupCell;
import com.github.exerrk.components.table.StandardTableFactory;
import com.github.exerrk.components.table.TableReportContextXmlRule;
...
import com.github.exerrk.engine.xml.JRExpressionFactory;
import com.github.exerrk.engine.xml.JRXmlConstants;
import com.github.exerrk.engine.xml.JRXmlWriter;
import com.github.exerrk.engine.xml.StyleContainerRule;
import com.github.exerrk.engine.xml.UuidPropertyRule;
import com.github.exerrk.engine.xml.XmlConstantPropertyRule;
...
public class ComponentsXmlDigesterConfigurer implements XmlDigesterConfigurer
{
	...
	protected void addMapRules(Digester digester)
	{
		...
		digester.addFactoryCreate(markerDatasetPattern, com.github.exerrk.components.map.MarkerDatasetXmlFactory.class.getName());
		digester.addSetNext(markerDatasetPattern, "setMarkerDataset", com.github.exerrk.components.map.MarkerDataset.class.getName());

		String markerPattern = markerDatasetPattern + "/marker";
		digester.addFactoryCreate(markerPattern, com.github.exerrk.components.map.MarkerXmlFactory.class.getName());
		digester.addSetNext(markerPattern, "addMarker", com.github.exerrk.components.map.Marker.class.getName());

		String markerPropertyPattern = markerPattern + "/markerProperty";
		digester.addFactoryCreate(markerPropertyPattern, com.github.exerrk.components.map.MarkerPropertyXmlFactory.class.getName());
		digester.addSetNext(markerPropertyPattern, "addMarkerProperty", com.github.exerrk.components.map.MarkerProperty.class.getName());
