...
import com.github.exerrk.components.headertoolbar.json.ColumnFormatting;
			...
			for (int i = 0, ln = conditions.size(); i < ln; i ++) {
				...
				if (FilterTypesEnum.DATE.equals(conditionType) || FilterTypesEnum.TIME.equals(conditionType)) {
					...
					try {
						...
						if (containsBetween) {
							if (condition.getConditionStart() == null || condition.getConditionStart().length() == 0) {
								errors.add("com.github.exerrk.components.headertoolbar.actions.conditionalformatting.empty.start.date", i+1);
							} else {
								try {
									df.parse(condition.getConditionStart());
								} catch (ParseException e) {
									errors.add("com.github.exerrk.components.headertoolbar.actions.conditionalformatting.invalid.start.date", i+1, condition.getConditionStart());
								}
							}
							...
							if (condition.getConditionEnd() != null && condition.getConditionEnd().length() > 0) {
								try {
									...
									errors.add("com.github.exerrk.components.headertoolbar.actions.conditionalformatting.invalid.end.date", i+1, condition.getConditionEnd());
								}
							} else {
								errors.add("com.github.exerrk.components.headertoolbar.actions.conditionalformatting.empty.end.date", i+1);
							}
							
						} else {
							if (condition.getConditionStart() == null || condition.getConditionStart().length() == 0) {
								errors.add("com.github.exerrk.components.headertoolbar.actions.conditionalformatting.empty.date", i+1);
							} else {
								try {
									df.parse(condition.getConditionStart());
								} catch (ParseException e) {
									errors.add("com.github.exerrk.components.headertoolbar.actions.conditionalformatting.invalid.date", i+1, condition.getConditionStart());
								}
							}
						}
					} catch (IllegalArgumentException e) {
						errors.add("com.github.exerrk.components.headertoolbar.actions.conditionalformatting.invalid.pattern", i+1);
					}
					...
					if (condition.getConditionStart() == null || condition.getConditionStart().trim().length() == 0) {
						errors.add("com.github.exerrk.components.headertoolbar.actions.conditionalformatting.empty.number", i+1);
						continue;
					}
					try {
						...
						if (condition.getConditionEnd() != null && condition.getConditionEnd().length() > 0) {
							try {
								...
								errors.add("com.github.exerrk.components.headertoolbar.actions.conditionalformatting.invalid.number", i+1, condition.getConditionEnd());
							}
						}
					} catch (ParseException e) {
						errors.add("com.github.exerrk.components.headertoolbar.actions.conditionalformatting.invalid.number", i+1, condition.getConditionStart());
					} catch (IllegalArgumentException e) {
						errors.add("com.github.exerrk.components.headertoolbar.actions.conditionalformatting.invalid.pattern", i+1);
					}
				}
