 ...
 */
public class FillMarker implements com.github.exerrk.components.map.Marker
{
	 ...
	 *
	 */
	protected com.github.exerrk.components.map.Marker parent;
	...
	{
		List<com.github.exerrk.components.map.MarkerProperty> markerProperties = getProperties();
	...
	@Override
	public List<com.github.exerrk.components.map.MarkerProperty> getProperties()
	{
		return parent.getProperties();
	}
	
	public Object getEvaluatedValue(
		com.github.exerrk.components.map.MarkerProperty property,
		...
		) throws JRException
	{
		...
		{
			if(
				com.github.exerrk.components.map.Marker.PROPERTY_latitude.equals(property.getName())
				|| com.github.exerrk.components.map.Marker.PROPERTY_longitude.equals(property.getName())
				)
			{
