 ...
 * @deprecated Replaced by {@link com.github.exerrk.components.items.Item}.
 */
public interface Item extends JRCloneable 
{

	/**
	 * Returns a list of {@link com.github.exerrk.components.map.ItemProperty ItemProperty} objects.
